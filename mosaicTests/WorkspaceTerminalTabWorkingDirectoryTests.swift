...
struct WorkspaceTerminalTabWorkingDirectoryTests {
    ...
    func remoteRestoreDoesNotReplaceIntentionalNilTerminalWorkingDirectoryWithWorkspaceCurrentDirectory() throws {
        let workspaceDirectory = "/tmp/mosaic-remote-restore-\(UUID().uuidString)"
    ...
    func newTerminalToRightUsesAnchorTabWorkingDirectoryWhenAnchorIsNotSelected() throws {
        let selectedDirectory = "/tmp/mosaic-selected-\(UUID().uuidString)"
        let anchorDirectory = "/tmp/mosaic-anchor-\(UUID().uuidString)"
        let workspace = Workspace(workingDirectory: "/tmp/mosaic-workspace-\(UUID().uuidString)")
    ...
    func surfaceCreateInheritsWorkspaceCurrentDirectoryForAgentPane() throws {
        ...
        let workspaceDirectory = "/tmp/mosaic-surface-create-\(UUID().uuidString)"
