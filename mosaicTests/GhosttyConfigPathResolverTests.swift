...
final class GhosttyConfigPathResolverTests: XCTestCase {
    func testMosaicAppSupportConfigURLsUseReleaseConfigForDebugBundleWithoutCurrentConfig() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            ...
            XCTAssertEqual(
                GhosttyApp.mosaicAppSupportConfigURLs(
    ...
    func testMosaicAppSupportConfigURLsPreferConfigGhosttyOverLegacyConfigWhenBothExist() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
    ...
    func testMosaicAppSupportConfigURLsPreferCurrentBundleConfigWhenPresent() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            _ = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicAppSupportConfigURLsPreserveSymlinkedConfigURL() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
    ...
    func testConfigSourceEnvironmentSaveWritesThroughSymlinkedMosaicConfig() throws {
        try withTemporaryHomeDirectory { homeDirectory in
            ...
            try environment.writeMosaicConfigContents("theme = light:Andromeda,dark:3024 Day\n")
            ...
            XCTAssertEqual(environment.mosaicConfigURL, symlinkedConfigURL)
        }
    }
    ...
    func testMaterializeWritesSelectedEditableConfigWhenLegacyConfigAppearsDuringCheck() throws {
        try withTemporaryHomeDirectory { homeDirectory in
            ...
            let materializedURL = try environment.materializeMosaicConfigFileIfNeeded()
    ...
    func testMosaicAppSupportConfigURLsUseNightlyConfigWhenPresent() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            _ = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicAppSupportConfigURLsUseReleaseConfigForNightlyWithoutCurrentConfig() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            let releaseConfigURL = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicAppSupportConfigURLsUseStagingConfigWhenPresent() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            _ = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicAppSupportConfigURLsUseReleaseConfigForStagingWithoutCurrentConfig() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            let releaseConfigURL = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicAppSupportConfigURLsSkipReleaseFallbackForNonDebugBundle() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            _ = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicConfigPathResolverOpensLegacyConfigWhenConfigGhosttyIsEmpty() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            let legacyConfigURL = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testMosaicConfigPathResolverTargetsCurrentConfigGhosttyWhenNoActiveConfigExists() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
    ...
    func testMosaicAppSupportConfigURLsIgnoreMissingOrEmptyFiles() throws {
        try withTemporaryAppSupportDirectory { appSupportDirectory in
            _ = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: "mosaic.com.emergent.app",
    ...
    func testGhosttySettingsEditorURLsMaterializeMosaicConfigWhenNoConfigExists() throws {
        try withTemporaryHomeDirectory { homeDirectory in
            let environment = ConfigSourceEnvironment(
                homeDirectoryURL: homeDirectory,
    ...
    func testGhosttySettingsEditorURLsIncludeStandaloneAppSupportAndRecursiveConfigFiles() throws {
        try withTemporaryHomeDirectory { homeDirectory in
            ...
            let mosaicConfigURL = try writeAppSupportConfig(
                appSupportDirectory: appSupportDirectory,
                bundleIdentifier: bundleIdentifier,
                filename: "config.ghostty",
                contents: "theme = mosaic\nconfig-file = mosaic-include.conf\n"
            )
            let mosaicIncludeURL = mosaicConfigURL
                .deletingLastPathComponent()
                .appendingPathComponent("mosaic-include.conf", isDirectory: false)
            try "font-size = 16\n".write(to: mosaicIncludeURL, atomically: true, encoding: .utf8)
    ...
    private func withTemporaryAppSupportDirectory(
        ...
        let directory = fileManager.temporaryDirectory
            .appendingPathComponent("mosaic-app-support-\(UUID().uuidString)", isDirectory: true)
