...
extension MosaicCLIErrorOutputRegressionTests {
    @Test func testSessionsListReportsCodexIdsMissingFromCodexStore() throws {
        let cliPath = try bundledCLIPath()
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-sessions-list-\(UUID().uuidString)", isDirectory: true)
        ...
        environment["MOSAIC_AGENT_HOOK_STATE_DIR"] = stateDir.path
