...
final class FilePreviewReviewFeedbackTests: XCTestCase {
    func testAppBundleExportsFilePreviewDragType() {
        ...
        XCTAssertTrue(
            exported.contains("com.mosaic.filepreview.transfer"),
    ...
    // Regression test for emergent-inc/mosaic#4576: drag-selecting deep into a large file pegged the
