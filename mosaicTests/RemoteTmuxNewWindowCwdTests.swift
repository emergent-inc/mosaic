...
/// Regression coverage for remote-tmux (`mosaic ssh-tmux`) new-tab cwd inheritance.
///
/// In local mosaic a new tab inherits the active tab's working directory; the
...
/// focused tab's directory. mosaic appends that directory onto the placement
