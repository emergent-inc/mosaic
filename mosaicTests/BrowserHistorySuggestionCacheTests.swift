...
@Suite struct BrowserHistorySuggestionCacheTests {
    private func makeStore() -> (store: BrowserHistoryStore, fileURL: URL) {
        let fileURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-history-suggest-\(UUID().uuidString).json")
    ...
    @Test func suggestionsMatchHostAndTitleAfterCaching() {
        ...
        store.recordVisit(url: URL(string: "https://github.com/emergent-inc/mosaic/issues"), title: "mosaic issues")
        ...
        #expect(results.contains("https://github.com/emergent-inc/mosaic/issues"))
