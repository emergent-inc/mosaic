...
extension MosaicCLIErrorOutputRegressionTests {
    ...
    final class MosaicTestExpectation {
    ...
    func expectation(description: String) -> MosaicTestExpectation {
        MosaicTestExpectation(description: description)
    }

    func wait(for expectations: [MosaicTestExpectation], timeout: TimeInterval) {
