...
// compiled into both the `mosaic-cli` target and this test target — so the pure
// classification decision can be unit-tested directly, without `@testable`
// importing the `mosaic_cli` executable module (whose symbols the app-hosted
...
///
/// https://github.com/emergent-inc/mosaic/issues/4985
...
struct FeedEventClassificationTests {
    ...
    /// telemetry. Otherwise "Approve for me" gets bypassed by mosaic's Feed UI.
