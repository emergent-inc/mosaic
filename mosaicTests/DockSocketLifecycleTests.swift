...
struct DockSocketLifecycleTests {
    ...
    func dockPaneRoutingAndFocusedCloseStayInDock() throws {
        ...
        try withDockEnabled {
            ...
            activeWindow.identifier = NSUserInterfaceItemIdentifier("mosaic.main.\(activeWindowId.uuidString)")
            ...
            dockWindow.identifier = NSUserInterfaceItemIdentifier("mosaic.main.\(dockWindowId.uuidString)")
