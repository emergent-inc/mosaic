...
/// Regression coverage for https://github.com/emergent-inc/mosaic/issues/5227.
///
/// In a mosaic window every keyDown is funneled through the swizzled
...
struct EditableTextViewArrowKeyForwardingTests {
    ...
    func doesNotStealCommandOptionArrowFromPaneFocusShortcut(keyCode: UInt16) {
        // Cmd+Option+Arrow is reserved for mosaic pane-focus shortcuts and must
