...
export async function POST(request: Request): Promise<Response> {
  ...
  // https://github.com/emergent-inc/mosaic/issues/5569). The only reusable limiter in
  ...
  // anonymous IP/edge rate limit on mosaic's own compute is the follow-up. The
