...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "blog.mosaicOmo" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "mosaic", "OpenCode", "oh-my-opencode", "oh-my-openagent", "tmux",
    ...
    alternates: buildAlternates(locale, "/blog/mosaic-omo"),
  };
}

export default function MosaicOmoPage() {
  const t = useTranslations("blog.posts.mosaicOmo");
  const tc = useTranslations("common");

  return (
    <>
      <BlogSchema postKey="mosaicOmo" path="/blog/mosaic-omo" datePublished="2026-03-30T00:00:00Z" />
      <div className="mb-8">
        <Link
          href="/blog"
