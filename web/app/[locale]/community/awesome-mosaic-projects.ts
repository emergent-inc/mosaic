export type AwesomeMosaicProject = {
  name: string;
  url: string;
  agent?: string;
...
export const awesomeMosaicSourceUrl = "https://github.com/emergent-inc/awesome-mosaic";
export const awesomeMosaicCuratedProjectRows = 150;

export const awesomeMosaicCategoryOrder = [
...
export const awesomeMosaicProjects = [
  {
  ...
  {
    "name": "emergent-inc/mosaic-skills",
    "url": "https://github.com/emergent-inc/mosaic-skills",
    "agent": "Multi",
    "descriptionKey": "p077",
    "language": "Python",
    "categories": [
  ...
  {
    "name": "emergent-inc/homebrew-mosaic",
    "url": "https://github.com/emergent-inc/homebrew-mosaic",
    "descriptionKey": "p078",
    "language": "Ruby",
    "categories": [
      "Build & Distribution"
...
] as const satisfies readonly AwesomeMosaicProject[];
