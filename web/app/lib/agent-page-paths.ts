...
export const agentReadablePages = [
  { path: "/", title: "Home" },
  { path: "/ios", title: "mosaic iOS" },
  { path: "/blog", title: "Blog" },
  { path: "/blog/mosaic-home", title: "mosaic home" },
  { path: "/blog/mosaic-history", title: "mosaic history" },
  { path: "/blog/mosaic-finder", title: "Introducing mosaic Finder" },
  { path: "/blog/mosaic-vault", title: "mosaic Vault" },
  { path: "/blog/passkey-auth", title: "Passkey auth in the mosaic browser" },
  { path: "/blog/task-manager", title: "Task Manager in mosaic" },
  { path: "/blog/markdown-viewer", title: "A better markdown viewer in mosaic" },
  { path: "/blog/unread-shortcuts", title: "Unread workspace shortcuts in mosaic" },
  { path: "/blog/session-restore", title: "Session restore in mosaic" },
  { path: "/blog/mosaic-ssh", title: "mosaic SSH" },
  {
    path: "/blog/mosaic-claude-teams",
    title: "Claude Code teammate agents as native mosaic panes",
  },
  {
    path: "/blog/mosaic-omo",
    title: "oh-my-openagent subagents as native mosaic panes",
  },
  { path: "/blog/gpl", title: "mosaic is now GPL" },
  { path: "/blog/cmd-shift-u", title: "Cmd+Shift+U" },
  { path: "/blog/zen-of-mosaic", title: "The Zen of mosaic" },
  { path: "/blog/show-hn-launch", title: "Launching mosaic on Show HN" },
  { path: "/blog/introducing-mosaic", title: "Introducing mosaic" },
...
export function buildLlmsText(origin: string): string {
  const lines = [
    ...
    "## Programmable",
    "",
    "mosaic is designed to be driven by scripts and agents, not just used by hand. Every command is available through both a `mosaic` CLI and a Unix socket, so anything an agent has in its PATH can control the running app:",
    "",
    ...
    "- Hooks: run your own commands on mosaic events to wire it into other tools and notification pipelines.",
    ...
    "- Automation: `mosaic` CLI and Unix socket API, browser automation, hooks, skills, and custom commands",
    `- Download: ${origin}/download`,
    "- Source: https://github.com/emergent-inc/mosaic",
    "",
    "## Page variants",
    "",
