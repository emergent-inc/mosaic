...
export const shortcutCategories: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { id: "reloadConfiguration", combos: [["⌘", "⇧", ","]], description: { en: "Reload configuration" } },
      {
        ...
        combos: [["⌃", "⌥", "⌘", "."]],
        description: { en: "Show/hide all mosaic windows" },
      ...
      { id: "quit", combos: [["⌘", "Q"]], description: { en: "Quit mosaic" } },
    ],
  },
  {
    id: "workspaces",
    ...
    shortcuts: [
      ...
      { id: "prevSidebarTab", combos: [["⌃", "⌘", "["]], description: { en: "Previous workspace" } },
      {
        ...
        note: {
          en: "mosaic uses Cmd+[ and Cmd+] for focus history by default. Unbind Focus Back/Forward in Settings to let browser or terminal shortcuts handle those keys.",
        },
      },
      {
