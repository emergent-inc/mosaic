...
struct MosaicConfigUIDefinition: Codable, Sendable, Hashable {
    var newWorkspace: MosaicConfigButtonPlacement?
    var surfaceTabBar: MosaicSurfaceTabBarUIDefinition?
}

struct MosaicSurfaceTabBarUIDefinition: Codable, Sendable, Hashable {
    var buttons: [MosaicSurfaceTabBarButton]?
}

struct MosaicConfigButtonPlacement: Codable, Sendable, Hashable {
    var action: String?
    ...
    init(
        ...
        tooltip: String? = nil,
        contextMenu: [MosaicConfigContextMenuItem]? = nil
    ) {
        self.action = action
        self.icon = icon
    ...
    init(from decoder: Decoder) throws {
        ...
        contextMenu = try container.decodeIfPresent([MosaicConfigContextMenuItem].self, forKey: .contextMenu)
            ?? container.decodeIfPresent([MosaicConfigContextMenuItem].self, forKey: .rightClick)
    }
...
struct MosaicConfigContextMenuActionItem: Codable, Sendable, Hashable {
    var action: String
    var title: String?
    var icon: MosaicButtonIcon?
    var tooltip: String?
    ...
    init(action: String, title: String? = nil, icon: MosaicButtonIcon? = nil, tooltip: String? = nil) {
        self.action = action
        self.title = title
        self.icon = icon
        self.tooltip = tooltip
...
enum MosaicConfigContextMenuItem: Codable, Sendable, Hashable {
    case action(MosaicConfigContextMenuActionItem)
    case separator
    ...
    init(from decoder: Decoder) throws {
        if let container = try? decoder.singleValueContainer(),
           let rawAction = try? container.decode(String.self) {
            ...
            self = .action(MosaicConfigContextMenuActionItem(action: trimmed))
            return
        }
        ...
        self = .action(try MosaicConfigContextMenuActionItem(from: decoder))
    }
...
struct MosaicResolvedConfigMenuAction: Identifiable, Sendable, Hashable {
    var id: String
    var title: String
    var icon: MosaicButtonIcon?
    var iconSourcePath: String?
    var tooltip: String?
    var action: MosaicResolvedConfigAction
}

enum MosaicResolvedConfigContextMenuItem: Identifiable, Sendable, Hashable {
    case action(MosaicResolvedConfigMenuAction)
...
enum MosaicRestartBehavior: String, Codable, Sendable {
    case new
    case recreate
    case ignore
    case confirm
