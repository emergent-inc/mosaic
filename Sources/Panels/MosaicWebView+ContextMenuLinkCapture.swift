...
/// Context-menu link resolution for `MosaicWebView`.
///
...
extension MosaicWebView {
    ...
    /// stored property lives in `MosaicWebView.swift` because extensions cannot
    ...
    private static let contextMenuLinkCaptureMessageHandlerName = "mosaicContextMenuLinkCapture"
...
private final class ContextMenuLinkCaptureMessageHandler: NSObject, WKScriptMessageHandler {
    func userContentController(
        ...
        guard let webView = message.webView as? MosaicWebView else { return }
