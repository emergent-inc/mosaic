...
extension MosaicWebView {
    private static let scriptedDownloadMessageHandlerName = "mosaicScriptedDownload"
    ...
    (() => {
      try {
        if (window.__mosaicScriptedDownloadInstalled) return true;
        window.__mosaicScriptedDownloadInstalled = true;
    ...
    private func startScriptedWebKitDownload(
        ...
        guard let downloadDelegate = mosaicDownloadDelegate else {
#if DEBUG
...
private final class ScriptedDownloadMessageHandler: NSObject, WKScriptMessageHandler {
    func userContentController(
        ...
        guard let webView = message.webView as? MosaicWebView,
