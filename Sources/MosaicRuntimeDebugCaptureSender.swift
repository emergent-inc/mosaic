...
actor MosaicRuntimeDebugCaptureSender {
    private let maxInFlightRequests: Int
    private let sequence = MosaicRuntimeDebugCaptureSequence()
    ...
    func sendIfCapacityAvailable(
        configuration: MosaicRuntimeDebugCaptureConfiguration,
        hypothesisID: String,
        source: String,
        name: String,
        expected: String?,
