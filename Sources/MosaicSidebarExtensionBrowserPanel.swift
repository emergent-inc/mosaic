...
@MainActor
final class MosaicSidebarExtensionBrowserPanel: NSObject, Panel, ObservableObject {
    let id = UUID()
    ...
    init(title: String) {
        self.title = title
        self.browserViewController = MosaicSidebarExtensionBrowserPresenter.makeViewController(title: title)
        super.init()
    }
...
struct MosaicSidebarExtensionBrowserPanelView: NSViewControllerRepresentable {
    let panel: MosaicSidebarExtensionBrowserPanel
    let onRequestPanelFocus: () -> Void

    func makeNSViewController(context: Context) -> NSViewController {
        MosaicSidebarExtensionBrowserContainerViewController(
    ...
    func updateNSViewController(_ nsViewController: NSViewController, context: Context) {
        guard let container = nsViewController as? MosaicSidebarExtensionBrowserContainerViewController else {
            return
        }
    ...
    static func dismantleNSViewController(
        ...
        (nsViewController as? MosaicSidebarExtensionBrowserContainerViewController)?.detachBrowserForTransientReparent()
    }
}

@MainActor
private final class MosaicSidebarExtensionBrowserContainerViewController: NSViewController {
