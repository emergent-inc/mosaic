...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.automation, "team-session-sync", String(localized: "settings.automation.teamSessionSync", defaultValue: "Team Session Sync"), "team sessions sync share corpus handoff pull claude transcript cloud"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "automation.teamSessionSync": settingID(for: .automation, idSuffix: "team-session-sync"),
