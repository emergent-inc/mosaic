...
struct MosaicTopProcessArguments: Sendable {
    let arguments: [String]
    let environment: [String: String]
}

extension MosaicTopProcessSnapshot {
    static func processArgumentsAndEnvironment(for pid: Int) -> MosaicTopProcessArguments? {
    ...
    static func processArgumentsAndEnvironment(fromKernProcArgs bytes: [UInt8]) -> MosaicTopProcessArguments? {
