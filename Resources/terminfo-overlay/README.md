# mosaic terminfo overlay

mosaic ships patched `xterm-ghostty` and `xterm-256color` terminfo entries so
...
mosaic while preserving Ghostty's truecolor capabilities.
