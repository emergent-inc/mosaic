...
def _wait_focused(client: mosaic, expected_pane_id: str, timeout_s: float = 6.0) -> Optional[str]:
...
def _wait_url_loaded(client: mosaic, browser_id: str, timeout_s: float = 10.0) -> str:
