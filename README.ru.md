...
[Скачать cmux NIGHTLY](https://github.com/emergent-inc/cmux/releases/download/nightly/cmux-nightly-macos.dmg)
...
Сообщайте об ошибках в ночных сборках на [GitHub Issues](https://github.com/emergent-inc/cmux/issues) или в [#nightly-bugs в Discord](https://discord.gg/xsgFEVrWCZ).
...
Да, cmux бесплатен в использовании. Исходный код доступен на [GitHub](https://github.com/emergent-inc/cmux).

### Как я могу поддержать cmux?

cmux бесплатен и с открытым исходным кодом, и всегда будет таким. Если вы хотите поддержать разработку и получить ранний доступ к тому, что будет дальше, включая cmux AI, приложение для iOS и Cloud VMs, ознакомьтесь с [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition).

### У меня есть запрос на функцию или я нашёл ошибку?

Мы хотим об этом услышать. Откройте [issue](https://github.com/emergent-inc/cmux/issues) или [pull request](https://github.com/emergent-inc/cmux/pulls) на GitHub, или [напишите нам](mailto:contact@emergent.inc?subject=cmux%20feature%20request).
...
- Подписывайтесь на нас в X для получения обновлений [@emergentinc](https://x.com/emergentinc), [@lawrencecchen](https://x.com/lawrencecchen) и [@austinywang](https://x.com/austinywang)
- Присоединяйтесь к обсуждению в [Discord](https://discord.gg/xsgFEVrWCZ)
- Создавайте и участвуйте в [GitHub issues](https://github.com/emergent-inc/cmux/issues) и [обсуждениях](https://github.com/emergent-inc/cmux/discussions)
...
Если ваша организация не может соблюдать условия GPL, доступна коммерческая лицензия. Свяжитесь с [contact@emergent.inc](mailto:contact@emergent.inc) для получения подробностей.
