...
[ดาวน์โหลด cmux NIGHTLY](https://github.com/emergent-inc/cmux/releases/download/nightly/cmux-nightly-macos.dmg)
...
รายงานบั๊กของ nightly ได้ที่ [GitHub Issues](https://github.com/emergent-inc/cmux/issues) หรือใน [#nightly-bugs บน Discord](https://discord.gg/xsgFEVrWCZ)
...
มี Skills คือเวิร์กโฟลว์ที่นำกลับมาใช้ใหม่ได้ ซึ่งคุณสามารถมอบให้เอเจนต์ใด ๆ ที่รันใน cmux สำหรับสิ่งต่าง ๆ เช่น การควบคุม CLI การทำพื้นที่ทำงานอัตโนมัติ การตั้งค่า และพื้นผิวเบราว์เซอร์ เลือกดูคอลเลกชันแบบเปิดได้ที่ [cmux-skills](https://github.com/emergent-inc/cmux-skills) หรืออ่าน [เอกสาร skills](https://cmux.com/docs/skills)
...
ใช่ cmux ใช้งานได้ฟรี ซอร์สโค้ดมีให้บน [GitHub](https://github.com/emergent-inc/cmux)

### ผมจะสนับสนุน cmux ได้อย่างไร?

cmux ฟรีและโอเพนซอร์ส และจะเป็นเช่นนั้นเสมอ หากคุณต้องการสนับสนุนการพัฒนาและรับการเข้าถึงสิ่งที่กำลังจะมาก่อนใคร รวมถึง cmux AI, แอป iOS และ Cloud VMs ลองดู [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition)

### ผมมีคำขอฟีเจอร์หรือพบบั๊ก?

เราอยากได้ยิน เปิด [issue](https://github.com/emergent-inc/cmux/issues) หรือ [pull request](https://github.com/emergent-inc/cmux/pulls) บน GitHub หรือ [อีเมลหาเรา](mailto:contact@emergent.inc?subject=cmux%20feature%20request)
...
- ติดตามเราบน X เพื่อรับข่าวสาร [@emergentinc](https://x.com/emergentinc), [@lawrencecchen](https://x.com/lawrencecchen) และ [@austinywang](https://x.com/austinywang)
- เข้าร่วมการสนทนาบน [Discord](https://discord.gg/xsgFEVrWCZ)
- สร้างและเข้าร่วมใน [GitHub issues](https://github.com/emergent-inc/cmux/issues) และ [discussions](https://github.com/emergent-inc/cmux/discussions)
...
หากองค์กรของคุณไม่สามารถปฏิบัติตาม GPL ได้ มีสัญญาอนุญาตเชิงพาณิชย์ให้บริการ ติดต่อ [contact@emergent.inc](mailto:contact@emergent.inc) สำหรับรายละเอียด
