...
def wait_for_text(client: mosaic, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "mosaic drop [image] #1 (a).png").resolve()
    p2 = (tmp / "mosaic drop second & file!.jpg").resolve()
