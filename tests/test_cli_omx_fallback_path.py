#!/usr/bin/env python3
"""
Regression test: `mosaic omx` preserves fallback provider dirs in PATH.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="mosaic-omx-fallback-path-") as td:
        root = Path(td)
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `mosaic omx --version` failed with omx in a fallback dir")
    ...
    print("PASS: mosaic omx preserves fallback provider dirs in PATH")
    return 0
