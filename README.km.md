...
រាយការណ៍ពីបញ្ហា nightly នៅលើ [GitHub Issues](https://github.com/emergent-inc/cmux/issues) ឬនៅក្នុង [#nightly-bugs on Discord](https://discord.gg/xsgFEVrWCZ)។
...
មែន cmux ឥត​គិត​ថ្លៃ​ក្នុង​ការ​ប្រើ​ប្រាស់។ កូដ​ប្រភព​មាន​នៅ​លើ [GitHub](https://github.com/emergent-inc/cmux)។

### តើ​ខ្ញុំ​អាច​គាំទ្រ cmux យ៉ាង​ដូចម្ដេច?

cmux ឥត​គិត​ថ្លៃ​និង open source ហើយ​នឹង​នៅ​តែ​បែប​នេះ​ជានិច្ច។ ប្រសិន​បើ​អ្នក​ចង់​គាំទ្រ​ការ​អភិវឌ្ឍ​និង​ទទួល​បាន​ការ​ចូល​ដំណើរ​ការ​មុន​គេ​ចំពោះ​អ្វី​ដែល​នឹង​មក​ដល់ រួម​ទាំង cmux AI, កម្មវិធី iOS និង Cloud VMs សូម​មើល [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition)។

### ខ្ញុំ​មាន​សំណើ​មុខងារ ឬ​រក​ឃើញ​កំហុស?

យើង​ចង់​ស្ដាប់​វា។ បើក [issue](https://github.com/emergent-inc/cmux/issues) ឬ [pull request](https://github.com/emergent-inc/cmux/pulls) នៅ​លើ GitHub ឬ [អ៊ីមែល​មក​យើង](mailto:contact@emergent.inc?subject=cmux%20feature%20request)។
...
- តាមដានពួកយើងនៅលើ X សម្រាប់ព័ត៌មានថ្មីៗ [@emergentinc](https://x.com/emergentinc), [@lawrencecchen](https://x.com/lawrencecchen), និង [@austinywang](https://x.com/austinywang)
- ចូលរួមការសន្ទនានៅលើ [Discord](https://discord.gg/xsgFEVrWCZ)
- បង្កើត និងចូលរួមនៅក្នុង [GitHub issues](https://github.com/emergent-inc/cmux/issues) និង [discussions](https://github.com/emergent-inc/cmux/discussions)
...
ប្រសិនបើស្ថាប័នរបស់អ្នកមិនអាចអនុលោមតាម GPL បាន អាជ្ញាបណ្ណពាណិជ្ជកម្មមានផ្តល់ជូន។ សូមទាក់ទង [contact@emergent.inc](mailto:contact@emergent.inc) សម្រាប់ព័ត៌មានលម្អិត។
