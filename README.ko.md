...
[cmux NIGHTLY 다운로드](https://github.com/emergent-inc/cmux/releases/download/nightly/cmux-nightly-macos.dmg)

cmux NIGHTLY는 자체 번들 ID를 가진 별도의 앱이라 안정 버전과 함께 실행할 수 있어요. 최신 `main` 커밋에서 자동으로 빌드되고, 자체 Sparkle 피드를 통해 자동 업데이트돼요.

나이틀리 버그는 [GitHub Issues](https://github.com/emergent-inc/cmux/issues)나 [Discord의 #nightly-bugs](https://discord.gg/xsgFEVrWCZ)에서 알려주세요.
...
네. 스킬은 CLI 제어, 워크스페이스 자동화, 설정, 브라우저 surface 같은 작업을 위해 cmux에서 실행되는 어떤 에이전트에든 줄 수 있는 재사용 가능한 워크플로우예요. 오픈 컬렉션은 [cmux-skills](https://github.com/emergent-inc/cmux-skills)에서 둘러보거나 [스킬 문서](https://cmux.com/docs/skills)를 읽어보세요.
...
네, cmux는 무료로 사용할 수 있어요. 소스 코드는 [GitHub](https://github.com/emergent-inc/cmux)에서 볼 수 있어요.

### cmux를 어떻게 지원할 수 있나요?

cmux는 무료이고 오픈 소스이며, 앞으로도 그럴 거예요. 개발을 후원하고 cmux AI, iOS 앱, Cloud VMs를 포함해 다음에 나올 것들에 먼저 접근하고 싶다면, [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition)을 확인해주세요.

### 기능 요청이 있거나 버그를 발견했어요?

꼭 듣고 싶어요. GitHub에서 [issue](https://github.com/emergent-inc/cmux/issues)나 [pull request](https://github.com/emergent-inc/cmux/pulls)를 열거나, [이메일을 보내주세요](mailto:contact@emergent.inc?subject=cmux%20feature%20request).
...
- X에서 팔로우해주세요: [@emergentinc](https://x.com/emergentinc), [@lawrencecchen](https://x.com/lawrencecchen), [@austinywang](https://x.com/austinywang)
- [Discord](https://discord.gg/xsgFEVrWCZ)에서 대화에 참여해주세요
- [GitHub Issues](https://github.com/emergent-inc/cmux/issues)와 [토론](https://github.com/emergent-inc/cmux/discussions)에 참여해주세요
...
GPL을 준수할 수 없는 조직을 위해 상용 라이선스도 제공돼요. 자세한 내용은 [contact@emergent.inc](mailto:contact@emergent.inc)으로 문의해주세요.
