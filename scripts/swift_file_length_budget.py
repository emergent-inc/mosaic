#!/usr/bin/env python3
"""Check mosaic-owned Swift file lengths against a checked-in budget."""
...
DEFAULT_ROOTS = ("Sources", "CLI", "Packages", "mosaicTests", "mosaicUITests")
...
def write_budget(path: pathlib.Path, budget: FileLengthBudget) -> None:
    ...
    with path.open("w", encoding="utf-8") as handle:
        handle.write("# mosaic-owned Swift file length budget.\n")
...
def main(argv: list[str]) -> int:
    ...
    print_file_summary("All scanned mosaic-owned Swift files", file_lengths)
