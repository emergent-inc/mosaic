#!/usr/bin/env bash
# Inside-out codesign a mosaic .app bundle for Developer ID + notarization.
#
# Usage:
#   scripts/sign-mosaic-bundle.sh <app-path> <app-entitlements> <signing-identity>
#
# Example:
#   scripts/sign-mosaic-bundle.sh \
...
#
# Optional env:
#   MOSAIC_HELPER_ENTITLEMENTS  (default: mosaic-helper.entitlements)
#   MOSAIC_TIMESTAMP             set to "none" for un-timestamped local sigs
#
...
APP_ENTITLEMENTS="$2"
IDENTITY="$3"
HELPER_ENTITLEMENTS="${MOSAIC_HELPER_ENTITLEMENTS:-mosaic-helper.entitlements}"
