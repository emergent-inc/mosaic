...
public struct MosaicMobileRuntime: Sendable, MobileSyncRuntime {
    ...
    public init(
        ...
        pairingAttemptTimeoutNanoseconds: UInt64 = MosaicMobileRuntime.defaultPairingAttemptTimeoutNanoseconds,
...
struct MobileShellDevStackAuthTokenProvider {
    ...
    static let environmentKey = "MOSAIC_MOBILE_DEV_STACK_AUTH_TOKEN"
