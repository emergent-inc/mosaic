...
/// Adapts the auth runtime's ``MosaicAuthRuntime/TokenProviding`` to the analytics
/// package's ``MosaicMobileAnalytics/AnalyticsTokenProviding``.
///
/// The analytics package must not depend on `MosaicAuthRuntime`, so this bridge
