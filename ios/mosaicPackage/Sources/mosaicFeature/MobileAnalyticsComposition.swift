...
///
/// Builds the de-singletonized ``MosaicMobileAnalytics/AnalyticsEmitter`` once at
...
public struct MobileAnalyticsComposition {
    ...
    ///
    /// - Parameters:
    ///   - apiBaseURL: The mosaic web API base URL (no trailing slash), from
    ...
    /// ``MosaicMobileAnalytics/AnalyticsEmitter``.
