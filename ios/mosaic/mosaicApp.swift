...
struct mosaicApp: App {
    ...
    private static let root: AppCompositionRoot = {
        ...
        let runtime = MosaicMobileRuntime(
            ...
            stackAccessTokenProvider: MosaicMobileRuntime.stackAccessTokenProvider(from: auth.coordinator),
            stackAccessTokenForStatusProvider: MosaicMobileRuntime.stackAccessTokenForStatusProvider(from: auth.coordinator),
            stackAccessTokenForceRefresher: MosaicMobileRuntime.stackAccessTokenForceRefresher(from: auth.coordinator)
        )
