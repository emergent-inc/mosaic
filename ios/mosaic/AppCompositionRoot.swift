...
/// Holds the de-singletonized graph the `mosaicApp` builds once at launch.
///
...
final class AppCompositionRoot {
    ...
    init(
        ...
        // (`MOSAIC_UITEST_MOCK_DATA`/XCUITest) or a dogfood auto-pair attach URL is
    ...
    /// the injected ``MosaicMobileAnalytics/AnalyticsSessionizer`` and persisted
    /// ``MosaicMobileAnalytics/AnalyticsSessionStore``, emitting `ios_session_started`
