...
struct MosaicAgentTurnDiffBaselineRecord: Codable {
...
struct MosaicAgentTurnDiffBaselineStore: Codable {
    var version: Int = 1
    var records: [MosaicAgentTurnDiffBaselineRecord] = []
}

private enum MosaicAgentTurnUntrackedSnapshotLimits {
    static let maxFiles = 64
    static let maxFileBytes: UInt64 = 1 * 1024 * 1024
    static let maxTotalBytes: UInt64 = 4 * 1024 * 1024
}

enum MosaicAgentTurnDiffBaselineFile {
    static func path(env: [String: String] = ProcessInfo.processInfo.environment) -> String {
        if let overrideDirectory = normalized(env["MOSAIC_AGENT_HOOK_STATE_DIR"]) {
        ...
        return homeExpandedPath("~/.mosaicterm/agent-turn-diff-baselines.json", env: env)
    }
...
enum MosaicDiffViewerLocalization {
    static func string(
        _ key: String,
        defaultValue: String,
...
extension MosaicCLI {
    ...
    private struct DiffViewerURLMapper {
        ...
        static let sessionHistoryMarker = "mosaic-diff-viewer"
        ...
        func viewerURL(for fileURL: URL) throws -> URL {
            ...
            if origin.scheme == Self.scheme {
                ...
                // (`mosaic-diff-viewer://<token>`), and the in-app scheme handler
    ...
    /// `/__mosaic_diff_viewer_branch` regenerate endpoint runs in the separate
    /// server process, which has none of the original `mosaic diff` invocation's
    ...
    private struct DiffViewerLabels {
        ...
        static func localized() -> DiffViewerLabels {
            DiffViewerLabels(values: [
                "additions": MosaicDiffViewerLocalization.string("diffViewer.additions", defaultValue: "Additions"),
                "addComment": MosaicDiffViewerLocalization.string("diffViewer.addComment", defaultValue: "Add comment"),
                "bars": MosaicDiffViewerLocalization.string("diffViewer.bars", defaultValue: "Bars"),
                "cancelComment": MosaicDiffViewerLocalization.string("diffViewer.cancelComment", defaultValue: "Cancel"),
                "comments": MosaicDiffViewerLocalization.string("diffViewer.comments", defaultValue: "Comments"),
                "commentPlaceholder": MosaicDiffViewerLocalization.string("diffViewer.commentPlaceholder", defaultValue: "Leave a comment"),
                "deleteComment": MosaicDiffViewerLocalization.string("diffViewer.deleteComment", defaultValue: "Delete"),
                "editComment": MosaicDiffViewerLocalization.string("diffViewer.editComment", defaultValue: "Edit"),
                "noComments": MosaicDiffViewerLocalization.string("diffViewer.noComments", defaultValue: "No comments yet"),
                "outdatedComment": MosaicDiffViewerLocalization.string("diffViewer.outdatedComment", defaultValue: "Outdated"),
                "saveComment": MosaicDiffViewerLocalization.string("diffViewer.saveComment", defaultValue: "Comment"),
                "changedFiles": MosaicDiffViewerLocalization.string("diffViewer.changedFiles", defaultValue: "Changed files"),
                "classic": MosaicDiffViewerLocalization.string("diffViewer.classic", defaultValue: "Classic"),
                "commit": MosaicDiffViewerLocalization.string("about.commit", defaultValue: "Commit"),
                "collapseAllDiffs": MosaicDiffViewerLocalization.string("diffViewer.collapseAllDiffs", defaultValue: "Collapse all diffs"),
                "collapseUnchangedContext": MosaicDiffViewerLocalization.string("diffViewer.collapseUnchangedContext", defaultValue: "Collapse unchanged context"),
                "copyFailedGitApplyCommand": MosaicDiffViewerLocalization.string("diffViewer.copyFailedGitApplyCommand", defaultValue: "Could not copy git apply command."),
                "copiedGitApplyCommand": MosaicDiffViewerLocalization.string("diffViewer.copiedGitApplyCommand", defaultValue: "Copied git apply command"),
                "copyGitApplyCommand": MosaicDiffViewerLocalization.string("diffViewer.copyGitApplyCommand", defaultValue: "Copy git apply command"),
                "deletions": MosaicDiffViewerLocalization.string("diffViewer.deletions", defaultValue: "Deletions"),
                "diffStats": MosaicDiffViewerLocalization.string("diffViewer.diffStats", defaultValue: "Diff stats"),
                "diffTarget": MosaicDiffViewerLocalization.string("diffViewer.diffTarget", defaultValue: "Diff target"),
                "diffViewer": MosaicDiffViewerLocalization.string("diffViewer.diffViewer", defaultValue: "Diff viewer"),
                "renderFailed": MosaicDiffViewerLocalization.string("diffViewer.renderFailed", defaultValue: "Could not render this diff. Check the patch input and try again."),
                "disableWordDiffs": MosaicDiffViewerLocalization.string("diffViewer.disableWordDiffs", defaultValue: "Disable word diffs"),
                "disableWordWrap": MosaicDiffViewerLocalization.string("diffViewer.disableWordWrap", defaultValue: "Disable word wrap"),
                "enableWordDiffs": MosaicDiffViewerLocalization.string("diffViewer.enableWordDiffs", defaultValue: "Enable word diffs"),
                "enableWordWrap": MosaicDiffViewerLocalization.string("diffViewer.enableWordWrap", defaultValue: "Enable word wrap"),
                "expandAllDiffs": MosaicDiffViewerLocalization.string("diffViewer.expandAllDiffs", defaultValue: "Expand all diffs"),
                "expandUnchangedContext": MosaicDiffViewerLocalization.string("diffViewer.expandUnchangedContext", defaultValue: "Expand unchanged context"),
                "files": MosaicDiffViewerLocalization.string("diffViewer.files", defaultValue: "Files"),
                "hideBackgrounds": MosaicDiffViewerLocalization.string("diffViewer.hideBackgrounds", defaultValue: "Hide backgrounds"),
                "hideFiles": MosaicDiffViewerLocalization.string("diffViewer.hideFiles", defaultValue: "Hide files"),
                "hideFileSearch": MosaicDiffViewerLocalization.string("diffViewer.hideFileSearch", defaultValue: "Hide file search"),
                "hideLineNumbers": MosaicDiffViewerLocalization.string("diffViewer.hideLineNumbers", defaultValue: "Hide line numbers"),
                "indicatorStyle": MosaicDiffViewerLocalization.string("diffViewer.indicatorStyle", defaultValue: "Indicator style"),
                "jumpToFile": MosaicDiffViewerLocalization.string("diffViewer.jumpToFile", defaultValue: "Jump to file"),
                "loadingDiff": MosaicDiffViewerLocalization.string("diffViewer.loadingDiff", defaultValue: "Loading diff..."),
                "loadingRenderer": MosaicDiffViewerLocalization.string("diffViewer.loadingRenderer", defaultValue: "Loading renderer..."),
                "noFileDiffs": MosaicDiffViewerLocalization.string("diffViewer.noFileDiffs", defaultValue: "No file diffs found in patch input."),
                "none": MosaicDiffViewerLocalization.string("diffViewer.none", defaultValue: "None"),
                "openSourceURL": MosaicDiffViewerLocalization.string("diffViewer.openSourceURL", defaultValue: "Open source URL"),
                "options": MosaicDiffViewerLocalization.string("diffViewer.options", defaultValue: "Options"),
                "parsingDiff": MosaicDiffViewerLocalization.string("diffViewer.parsingDiff", defaultValue: "Parsing diff..."),
                "refresh": MosaicDiffViewerLocalization.string("diffViewer.refresh", defaultValue: "Refresh"),
                "renderingDiff": MosaicDiffViewerLocalization.string("diffViewer.renderingDiff", defaultValue: "Rendering diff..."),
                "repoPath": MosaicDiffViewerLocalization.string("diffViewer.repoPath", defaultValue: "Repository path"),
                "branchBase": MosaicDiffViewerLocalization.string("diffViewer.branchBase", defaultValue: "Branch base"),
                "branchPickerCurrent": MosaicDiffViewerLocalization.string("diffViewer.branchPickerCurrent", defaultValue: "current"),
                "branchPickerBasePrefix": MosaicDiffViewerLocalization.string("diffViewer.branchPickerBasePrefix", defaultValue: "Base:"),
                "branchPickerComparing": MosaicDiffViewerLocalization.string("diffViewer.branchPickerComparing", defaultValue: "Comparing {head} against {base}"),
                "branchPickerFilterPlaceholder": MosaicDiffViewerLocalization.string("diffViewer.branchPickerFilterPlaceholder", defaultValue: "Filter branches"),
                "branchPickerGenerating": MosaicDiffViewerLocalization.string("diffViewer.branchPickerGenerating", defaultValue: "Generating diff against {ref}..."),
                "branchPickerGroupBranches": MosaicDiffViewerLocalization.string("diffViewer.branchPickerGroupBranches", defaultValue: "Branches"),
                "branchPickerGroupRecent": MosaicDiffViewerLocalization.string("diffViewer.branchPickerGroupRecent", defaultValue: "Recent"),
                "branchPickerGroupRemotes": MosaicDiffViewerLocalization.string("diffViewer.branchPickerGroupRemotes", defaultValue: "Remotes"),
                "branchPickerGroupSuggested": MosaicDiffViewerLocalization.string("diffViewer.branchPickerGroupSuggested", defaultValue: "Suggested"),
                "branchPickerGroupWorktrees": MosaicDiffViewerLocalization.string("diffViewer.branchPickerGroupWorktrees", defaultValue: "Worktrees"),
                "branchPickerLoadFailed": MosaicDiffViewerLocalization.string("diffViewer.branchPickerLoadFailed", defaultValue: "Could not load branches."),
                "branchPickerMore": MosaicDiffViewerLocalization.string("diffViewer.branchPickerMore", defaultValue: "{count} more, type to filter"),
                "branchPickerLoading": MosaicDiffViewerLocalization.string("diffViewer.branchPickerLoading", defaultValue: "Loading branches..."),
                "branchPickerNoMatches": MosaicDiffViewerLocalization.string("diffViewer.branchPickerNoMatches", defaultValue: "No matching branches"),
                "branchPickerOpen": MosaicDiffViewerLocalization.string("diffViewer.branchPickerOpen", defaultValue: "Change diff base"),
                "branchPickerUseRaw": MosaicDiffViewerLocalization.string("diffViewer.branchPickerUseRaw", defaultValue: "Use \"{ref}\" (raw)"),
                "showBackgrounds": MosaicDiffViewerLocalization.string("diffViewer.showBackgrounds", defaultValue: "Show backgrounds"),
                "showFiles": MosaicDiffViewerLocalization.string("diffViewer.showFiles", defaultValue: "Show files"),
                "showFileSearch": MosaicDiffViewerLocalization.string("diffViewer.showFileSearch", defaultValue: "Show file search"),
                "showLineNumbers": MosaicDiffViewerLocalization.string("diffViewer.showLineNumbers", defaultValue: "Show line numbers"),
                "switchToSplitDiff": MosaicDiffViewerLocalization.string("diffViewer.switchToSplitDiff", defaultValue: "Switch to split diff"),
                "switchToUnifiedDiff": MosaicDiffViewerLocalization.string("diffViewer.switchToUnifiedDiff", defaultValue: "Switch to unified diff"),
                "untitled": MosaicDiffViewerLocalization.string("diffViewer.untitled", defaultValue: "Untitled"),
            ])
        }
    }
    ...
    private enum DiffSource: CaseIterable, Equatable {
        ...
        var menuLabel: String {
            switch self {
            case .unstaged: return MosaicDiffViewerLocalization.string("diffViewer.source.unstaged", defaultValue: "Unstaged")
            case .staged: return MosaicDiffViewerLocalization.string("diffViewer.source.staged", defaultValue: "Staged")
            case .branch: return MosaicDiffViewerLocalization.string("diffViewer.source.branch", defaultValue: "Branch")
            case .lastTurn: return MosaicDiffViewerLocalization.string("diffViewer.source.lastTurn", defaultValue: "Last turn")
            }
        }

        var title: String {
            switch self {
            case .unstaged: return MosaicDiffViewerLocalization.string("diffViewer.title.unstagedChanges", defaultValue: "Unstaged changes")
            case .staged: return MosaicDiffViewerLocalization.string("diffViewer.title.stagedChanges", defaultValue: "Staged changes")
            case .branch: return MosaicDiffViewerLocalization.string("diffViewer.title.branchDiff", defaultValue: "Branch diff")
            case .lastTurn: return MosaicDiffViewerLocalization.string("diffViewer.title.lastTurnDiff", defaultValue: "Last turn diff")
            }
        }

        var emptyMessage: String {
            switch self {
            case .unstaged: return MosaicDiffViewerLocalization.string("diffViewer.empty.unstaged", defaultValue: "No unstaged changes to diff.")
            case .staged: return MosaicDiffViewerLocalization.string("diffViewer.empty.staged", defaultValue: "No staged changes to diff.")
            case .branch: return MosaicDiffViewerLocalization.string("diffViewer.empty.branch", defaultValue: "No branch changes to diff.")
            case .lastTurn: return MosaicDiffViewerLocalization.string("diffViewer.empty.lastTurn", defaultValue: "No last-turn changes to diff.")
            }
        }
    }
    ...
    func runOpenCommand(
        ...
        guard !parsedArgs.targets.isEmpty else {
            throw CLIError(message: "open requires at least one path or URL. Usage: mosaic open <path-or-url>...")
        }
        ...
        let workspaceRaw = parsedArgs.workspace ?? (parsedArgs.window == nil ? ProcessInfo.processInfo.environment["MOSAIC_WORKSPACE_ID"] : nil)
        ...
        let surfaceRaw = parsedArgs.surface ?? (shouldInheritCallerSurface ? ProcessInfo.processInfo.environment["MOSAIC_SURFACE_ID"] : nil)
    ...
    func runDiffCommand(
        ...
        guard parsedArgs.inputs.count <= 1 else {
            throw CLIError(message: "diff accepts at most one patch file. Usage: mosaic diff [patch-file|-] [options]")
        }
        ...
        func resolveTargetIfNeeded() throws {
            ...
            let surfaceRaw = parsedArgs.surface ?? (parsedArgs.window == nil ? ProcessInfo.processInfo.environment["MOSAIC_SURFACE_ID"] : nil)
    ...
    private func taggedDiffViewerExecutableURL(socketPath: String) -> URL? {
        ...
        let candidate = URL(fileURLWithPath: homePath, isDirectory: true)
            .appendingPathComponent("Library/Developer/Xcode/DerivedData/mosaic-\(tag)", isDirectory: true)
    ...
    private func parseOpenArguments(_ commandArgs: [String]) throws -> OpenArguments {
        ...
        while index < commandArgs.count {
            ...
            if isParsingOptions {
                ...
                default:
                    if arg.hasPrefix("-") {
                        throw CLIError(message: "open: unknown flag '\(arg)'. Usage: mosaic open <path-or-url>... [--workspace <id|ref|index>] [--surface <id|ref|index>] [--pane <id|ref|index>] [--window <id|ref|index>] [--focus true|false] [--no-focus]")
                    }
                }
            }
            ...
            if isParsingOptions {
                ...
                default:
                    if arg.hasPrefix("-"), arg != "-" {
                        throw CLIError(message: "diff: unknown flag '\(arg)'. Usage: mosaic diff [patch-file|-] [--source <unstaged|staged|branch|last-turn>] [--workspace <id|ref|index>] [--surface <id|ref|index>] [--window <id|ref|index>] [--session <id>] [--cwd <path>] [--base <ref>] [--focus true|false] [--no-focus] [--title <text>] [--layout split|unified] [--font-size <points>]")
                    }
                }
            }
    ...
    private func readDiffInput(
        ...
        guard let rawInput, rawInput != "-" else {
            guard isatty(STDIN_FILENO) == 0 else {
                throw CLIError(message: "diff requires a patch file, piped stdin, or a git source. Usage: mosaic diff <patch-file>|-|--unstaged|--staged|--branch|--last-turn")
            }
            let data = FileHandle.standardInput.readDataToEndOfFile()
            return DiffInput(
                patch: try decodeDiffData(data, sourceDescription: "stdin"),
                sourceLabel: "stdin",
                defaultTitle: "mosaic diff",
                emptyMessage: nil,
                externalURL: nil
            )
        }
        ...
        return DiffInput(
            ...
            defaultTitle: filename.isEmpty ? "mosaic diff" : filename,
            emptyMessage: nil,
            externalURL: nil
        )
    }
    ...
    private func diffViewerShouldStreamRemotePatch() -> Bool {
        let value = ProcessInfo.processInfo.environment["MOSAIC_DIFF_VIEWER_STREAM_REMOTE"]?
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .lowercased()
    ...
    private func readGitDiffInput(source: DiffSource, context: DiffSourceContext) throws -> DiffInput {
        ...
        case .lastTurn:
            guard let workspaceId = normalizedDiffSourceValue(context.workspaceId),
                ...
                throw CLIError(message: "mosaic diff --last-turn requires a workspace and surface context. Run it from a mosaic terminal or pass --workspace and --surface.")
            }
            let sessionId = normalizedDiffSourceValue(context.sessionId)
            let env = ProcessInfo.processInfo.environment
            let baselineStorePath = MosaicAgentTurnDiffBaselineFile.path(env: env)
    ...
    private func gitRepoRoot(startingAt directory: String) throws -> String {
        do {
            ...
            throw CLIError(message: "mosaic diff git sources require a git repository")
        }
    }
    ...
    private func diffBranchBaseReasonLabel(_ reason: String) -> String {
        ...
        case DiffBranchBaseReason.createdFrom:
            return MosaicDiffViewerLocalization.string("diffViewer.baseReason.createdFrom", defaultValue: "created from")
        case DiffBranchBaseReason.prBase:
            return MosaicDiffViewerLocalization.string("diffViewer.baseReason.prBase", defaultValue: "PR base")
        case DiffBranchBaseReason.forkPoint:
            return MosaicDiffViewerLocalization.string("diffViewer.baseReason.forkPoint", defaultValue: "fork point")
        case DiffBranchBaseReason.default:
            return MosaicDiffViewerLocalization.string("diffViewer.baseReason.default", defaultValue: "default")
        case DiffBranchBaseReason.manual:
            return MosaicDiffViewerLocalization.string("diffViewer.baseReason.manual", defaultValue: "manual")
        default:
            return reason
        }
    }
    ...
    /// choice. Otherwise walk the heuristic order: recorded mosaicBase -> PR base ->
    ...
    private func resolvedDiffBranchBase(_ rawBaseRef: String?, in repoRoot: String) throws -> DiffBranchBase {
        ...
        // 1. Recorded creation base written by new-mosaic-worktree.sh. Read-only.
        if let branchName,
           let recorded = try? gitSingleLine(["config", "--get", "branch.\(branchName).mosaicBase"], in: repoRoot),
           !recorded.isEmpty,
    ...
    private func diffBranchRefGroups(in repoRoot: String, selectedBaseRef: String?) -> [DiffBranchRefGroup] {
        ...
        // Surface each individual heuristic source so mosaicBase and PR base can
        ...
        if !suggestedRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "suggested",
                    label: MosaicDiffViewerLocalization.string("diffViewer.refGroup.suggested", defaultValue: "Suggested"),
                    rows: suggestedRows
                )
            )
        }
        ...
        if !worktreeRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "worktrees",
                    label: MosaicDiffViewerLocalization.string("diffViewer.refGroup.worktrees", defaultValue: "Worktrees"),
                    rows: worktreeRows
                )
            )
        }
        ...
        if !branchRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "branches",
                    label: MosaicDiffViewerLocalization.string("diffViewer.refGroup.branches", defaultValue: "Branches"),
                    rows: branchRows
                )
            )
        }
        ...
        if !remoteRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "remotes",
                    label: MosaicDiffViewerLocalization.string("diffViewer.refGroup.remotes", defaultValue: "Remotes"),
                    rows: remoteRows
                )
            )
        }
        ...
        if !recentRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "recent",
                    label: MosaicDiffViewerLocalization.string("diffViewer.refGroup.recent", defaultValue: "Recent"),
                    rows: recentRows
                )
            )
        }
    ...
    /// pattern fixed in https://github.com/emergent-inc/mosaic/pull/5347, and these
    ...
    private func gitUntrackedPatchSinceBaseline(
        record: MosaicAgentTurnDiffBaselineRecord,
        in repoRoot: String,
        storePath: String
    ) throws -> String {
    ...
    private func safeTemporaryGitPathURL(relativePath: String) -> (root: URL, file: URL)? {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-diff-untracked-\(UUID().uuidString)", isDirectory: true)
    ...
    private func gitUntrackedPathHashes(
        ...
        for path in paths {
            guard hashes.count < MosaicAgentTurnUntrackedSnapshotLimits.maxFiles,
            ...
            guard fileSize <= MosaicAgentTurnUntrackedSnapshotLimits.maxFileBytes,
                  capturedBytes + fileSize <= MosaicAgentTurnUntrackedSnapshotLimits.maxTotalBytes else {
                continue
            }
            do {
    ...
    func recordAgentTurnDiffBaseline(
        ...
        let storePath = MosaicAgentTurnDiffBaselineFile.path(env: env)
        let untrackedSnapshot = try gitUntrackedPathHashes(
            paths: untrackedPaths,
            in: repoRoot,
            storePath: storePath
        )
        let record = MosaicAgentTurnDiffBaselineRecord(
            workspaceId: workspaceId,
            surfaceId: surfaceId,
        ...
        do {
            var removedRecords: [MosaicAgentTurnDiffBaselineRecord] = []
            ...
            try updateAgentTurnDiffBaselineStore(path: storePath, update: { store in
                func matchesCurrentScope(_ existing: MosaicAgentTurnDiffBaselineRecord) -> Bool {
    ...
    private func agentTurnDiffBaselineCommit(in repoRoot: String) throws -> String {
        let stashResult = CLIProcessRunner.runProcess(
            executablePath: "/usr/bin/env",
            arguments: ["git", "-C", repoRoot, "stash", "create", "mosaic last turn baseline"],
            timeout: 60
        )
    ...
    private func latestAgentTurnDiffBaseline(
        ...
        sessionId: String?,
        env: [String: String]
    ) throws -> MosaicAgentTurnDiffBaselineRecord? {
        let store = try readAgentTurnDiffBaselineStore(path: MosaicAgentTurnDiffBaselineFile.path(env: env))
    ...
    private func readAgentTurnDiffBaselineStore(path: String) throws -> MosaicAgentTurnDiffBaselineStore {
        let url = URL(fileURLWithPath: path)
        guard FileManager.default.fileExists(atPath: url.path) else {
            return MosaicAgentTurnDiffBaselineStore()
        }
        let data = try Data(contentsOf: url)
        return try JSONDecoder().decode(MosaicAgentTurnDiffBaselineStore.self, from: data)
    }

    private func updateAgentTurnDiffBaselineStore(
        path: String,
        update: (inout MosaicAgentTurnDiffBaselineStore) throws -> Void,
        afterWrite: ((MosaicAgentTurnDiffBaselineStore) -> Void)? = nil
    ) throws {
        let url = URL(fileURLWithPath: path)
        ...
        var store = (try? readAgentTurnDiffBaselineStore(path: path)) ?? MosaicAgentTurnDiffBaselineStore()
        try update(&store)
    ...
    private func pruneAgentTurnDiffBaselineStore(_ store: inout MosaicAgentTurnDiffBaselineStore) {
    ...
    private func pruneAgentTurnDiffBaselineArtifacts(
        storePath: String,
        removedRecords: [MosaicAgentTurnDiffBaselineRecord],
        retainedRecords: [MosaicAgentTurnDiffBaselineRecord]
    ) {
    ...
    private func agentTurnDiffBaselineRecordEquals(
        _ lhs: MosaicAgentTurnDiffBaselineRecord,
        _ rhs: MosaicAgentTurnDiffBaselineRecord
    ) -> Bool {
    ...
    private func diffViewerAppearance(socketPath: String, fontSizeOverride: Double?) -> DiffViewerAppearance {
        ...
        appearance.lightTheme.generatedName = "mosaic-ghostty-light-\(themeSuffix)"
        appearance.darkTheme.generatedName = "mosaic-ghostty-dark-\(themeSuffix)"
    ...
    private func defaultDiffViewerAppearance() -> DiffViewerAppearance {
        var lightTheme = DiffViewerTheme(
            generatedName: "mosaic-ghostty-light",
        ...
        var darkTheme = DiffViewerTheme(
            generatedName: "mosaic-ghostty-dark",
    ...
    private func diffViewerLoadingDiffMessage(_ target: String) -> String {
        let format = MosaicDiffViewerLocalization.string(
    ...
    private func writeCompleteGitDiffViewerHTMLSet(
        ...
        // verbatim. With no explicit base, the heuristic resolver (mosaicBase -> PR
        ...
        for source in DiffSource.allCases {
            for option in repoCandidates where option.repoRoot != repoRoot {
                ...
                // renders against (and surfaces a picker for) the mosaicBase/PR/
    ...
    /// custom scheme (`mosaic-diff-viewer://<token>`) it yields a scheme URL whose
    ...
    private func diffViewerBranchRefsURL(origin: URL, repoRoot: String, token: String, base: String?) -> String {
        ...
        return diffViewerBranchEndpointURL(
            origin: origin,
            path: "/__mosaic_diff_viewer_refs",
    ...
    private func diffViewerBranchRegenerateURLTemplate(
        ...
        let withSentinel = diffViewerBranchEndpointURL(
            origin: origin,
            path: "/__mosaic_diff_viewer_branch",
            queryItems: [
                URLQueryItem(name: "group", value: groupID),
                URLQueryItem(name: "repo", value: repoRoot),
                URLQueryItem(name: "token", value: token),
                URLQueryItem(name: "base", value: "__MOSAIC_REF__")
            ]
        )
        ...
        // (arbitrary user path), leaving `base=__MOSAIC_REF__` unfilled and breaking
        // regeneration. `base` is the last query item, so `base=__MOSAIC_REF__`
        // appears verbatim and uniquely.
        return withSentinel.replacingOccurrences(of: "base=__MOSAIC_REF__", with: "base={ref}")
    }

    // MARK: - Headless picker commands (for the in-app custom-scheme handler)

    /// `mosaic __diff-viewer-refs --repo <root> [--base <ref>]` -> grouped refs JSON
    ...
    /// custom-scheme handler to mirror the HTTP `/__mosaic_diff_viewer_refs` route.
    ...
    /// `mosaic __diff-viewer-branch --group <g> --repo <root> --base <ref>` ->
    ...
    /// mirror the HTTP `/__mosaic_diff_viewer_branch` route after an app restart,
    ...
    private func agentTurnDiffBaselineRepoURLs(context: DiffSourceContext) -> [URL] {
        guard let workspaceId = normalizedDiffSourceValue(context.workspaceId),
              ...
              let store = try? readAgentTurnDiffBaselineStore(
                path: MosaicAgentTurnDiffBaselineFile.path(env: ProcessInfo.processInfo.environment)
              ) else {
            return []
        }
        let sessionId = normalizedDiffSourceValue(context.sessionId)
    ...
    private func diffViewerDirectory() throws -> URL {
        let directory = URL(fileURLWithPath: "/tmp", isDirectory: true)
            .appendingPathComponent("mosaic-diff-viewer-\(getuid())", isDirectory: true)
    ...
    private func startDiffViewerHTTPServer(rootDirectory: URL, runtime: URL? = nil) throws -> URL {
        guard let executableURL = diffViewerExecutableURL(for: runtime) else {
            throw CLIError(message: "Failed to resolve mosaic executable for diff viewer server")
        }
    ...
    private func diffViewerHTTPServerIsReachable(port: Int) -> Bool {
        guard let url = URL(string: "http://127.0.0.1:\(port)/__mosaic_diff_viewer_healthz") else {
            return false
        }
    ...
    private func handleDiffViewerHTTPConnection(
        ...
        do {
            ...
            if request.path == "/__mosaic_diff_viewer_healthz" {
                try sendDiffViewerHTTPResponse(
                    fileDescriptor: fd,
                    status: 200,
                    reason: "OK",
            ...
            if request.path == "/__mosaic_diff_viewer_refs" {
            ...
            if request.path == "/__mosaic_diff_viewer_branch" {
            ...
            if request.path.hasPrefix("/__mosaic_diff_viewer_wait/") {
    ...
    /// `GET /__mosaic_diff_viewer_refs?repo=<root>&token=<t>` -> grouped refs JSON.
    ...
    /// `GET /__mosaic_diff_viewer_branch?group=<g>&repo=<root>&base=<ref>` ->
    ...
    private func sendDiffViewerHTTPWaitForReplacement(
        ...
        let prefix = "/__mosaic_diff_viewer_wait/"
    ...
    private func diffViewerHTTPReplacementWaitTimeout() -> TimeInterval {
        ...
        let key = "MOSAIC_DIFF_VIEWER_WAIT_TIMEOUT_SECONDS"
    ...
    private func sendDiffViewerHTTPWaitTimedOut(fileDescriptor fd: Int32, omitBody: Bool) throws {
        let title = MosaicDiffViewerLocalization.string(
            "diffViewer.loadingDiff",
            defaultValue: "Loading diff..."
        )
        let message = MosaicDiffViewerLocalization.string(
    ...
    private func diffViewerHTTPFileIsPending(_ fileURL: URL) -> Bool {
        ...
        return text.contains("data-mosaic-diff-pending=\"true\"")
    }
    ...
    private func sendDiffViewerHTTPRemotePatch(
        ...
        headers["X-MOSAIC-Diff-Viewer-Remote"] = "github"
    ...
    private func diffViewerHTTPBaseHeaders(port: Int?) -> [String: String] {
        ...
        if let port {
            ...
            headers["X-MOSAIC-Diff-Viewer-Origin"] = "http://127.0.0.1:\(port)"
        }
        return headers
    }
    ...
    private func writeDiffViewerRedirectHTML(
        ...
        <body data-mosaic-diff-redirect="\(escapedTarget)">
          <script>
    ...
    private func writeDiffViewerHTML(
        ...
        let pendingAttribute = pollForReplacement ? " data-mosaic-diff-pending=\"true\"" : ""
        let prepaintStyle = diffViewerPrepaintStyle(appearance: appearance)
        let html = """
        <!doctype html>
        ...
        <body>
          <script id="mosaic-diff-viewer-config" type="application/json">\(configLiteral)</script>
          <div id="root"></div>
    ...
    private func diffViewerPrepaintStyle(appearance: DiffViewerAppearance) -> String {
        ...
        return """
        <style id="mosaic-diff-viewer-prepaint">
          :root {
    ...
    private func ensureDiffViewerAssets(nextTo viewerURL: URL, runtime: URL? = nil) throws -> DiffViewerAssets {
        ...
        guard appAssetPaths.contains("main.mjs") else {
            throw CLIError(message: "Bundled mosaic diff viewer app entry asset not found")
        }
    ...
    private func diffViewerBundledAppAssetDirectory(
        ...
        let candidates: [(sourceName: String, targetName: String)] = [
            ("webviews-app", "mosaic-webviews-app"),
            ("diff-viewer-app", "mosaic-diff-viewer-app")
        ]
        for candidate in candidates {
            ...
            if FileManager.default.fileExists(atPath: appDirectory.path, isDirectory: &isDirectory),
               ...
               FileManager.default.fileExists(atPath: entry.path) {
                // The shared /tmp asset cache is written by every running mosaic
        ...
        throw CLIError(message: "Bundled mosaic diff viewer app assets not found")
    }
    ...
    private func diffViewerBundledAssetDirectoryCandidates(runtime: URL? = nil) -> [URL] {
        ...
        if let executableURL = diffViewerExecutableURL(for: runtime) {
            ...
            for _ in 0..<6 {
                ...
                let projectMarker = current.appendingPathComponent("mosaic.xcodeproj/project.pbxproj", isDirectory: false)
    ...
    func openSubcommandUsage() -> String {
        """
        Usage: mosaic open <path-or-url>... [options]

        Open files, directories, or URLs in mosaic.
        ...
        Options:
          --workspace <id|ref|index>   Target workspace (default: $MOSAIC_WORKSPACE_ID)
          --surface <id|ref|index>     Target surface whose pane should receive file tabs (default: $MOSAIC_SURFACE_ID)
        ...
        Examples:
          mosaic open report.pdf
          mosaic open image-a.png image-b.jpg
          mosaic open ~/Downloads/movie.mov --pane pane:1
          mosaic open https://example.com
        """
    }

    func diffSubcommandUsage() -> String {
        """
        Usage: mosaic diff [patch-file|-] [options]

        Render a unified diff or patch in a mosaic browser split.
        With no patch file or source, mosaic diff reads piped stdin.
        ...
        Options:
          ...
          --workspace <id|ref|index>   Target workspace (default: $MOSAIC_WORKSPACE_ID)
          --surface <id|ref|index>     Source surface to split from (default: $MOSAIC_SURFACE_ID)
          ...
          --layout <split|unified>     Diff layout (default: unified; configurable via diffViewer.defaultLayout in mosaic.json)
          --font-size <points>         Set diff font size (default: 10)

        Examples:
          mosaic diff changes.patch
          git diff | mosaic diff
          mosaic diff --unstaged
          mosaic diff --staged
          mosaic diff --branch
          mosaic diff --branch --base upstream/main --repo ../repo
          mosaic diff --last-turn
          mosaic diff pr.patch --layout unified --font-size 15 --focus true
        """
    }
