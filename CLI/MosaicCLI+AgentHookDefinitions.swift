...
extension MosaicCLI {
    ...
    struct AgentHookDef {
        ...
        let sessionStoreSuffix: String // e.g. "cursor" -> ~/.mosaicterm/cursor-hook-sessions.json
        let disableEnvVar: String   // e.g. "MOSAIC_CURSOR_HOOKS_DISABLED"
        let hookMarker: String      // Marker in commands: "mosaic hooks cursor"
        ...
        /// https://github.com/emergent-inc/mosaic/issues/5000.
        ///
        ...
        /// `agentEvent` that invokes `mosaic hooks feed --source <name>`
        ...
        /// Kiro applies its hooks only when run as the `mosaic` agent.
    ...
    static let agentDefs: [AgentHookDef] = [
        AgentHookDef(
            ...
            sessionStoreSuffix: "codex", disableEnvVar: "MOSAIC_CODEX_HOOKS_DISABLED",
            hookMarker: "mosaic hooks codex", format: .nested(timeoutMs: 5),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "UserPromptSubmit", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
            ],
            feedHookEvents: [
                "PreToolUse",
                "PermissionRequest",
        ...
        AgentHookDef(
            ...
            configDir: ".grok/hooks", configFile: "mosaic-session.json",
            configDirEnvOverride: "GROK_HOME", configDirEnvOverrideSubpath: "hooks",
            createConfigDirIfMissing: true,
            sessionStoreSuffix: "grok", disableEnvVar: "MOSAIC_GROK_HOOKS_DISABLED",
            hookMarker: "mosaic hooks grok", format: .nested(timeoutMs: 5000),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "UserPromptSubmit", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "Notification", mosaicSubcommand: "notification"),
                .init(agentEvent: "SessionEnd", mosaicSubcommand: "session-end"),
            ],
        ...
        AgentHookDef(
            ...
            configDir: ".config/opencode", configFile: "plugins/mosaic-session.js", configDirEnvOverride: "OPENCODE_CONFIG_DIR",
            sessionStoreSuffix: "opencode", disableEnvVar: "MOSAIC_OPENCODE_HOOKS_DISABLED",
            hookMarker: "mosaic hooks opencode", format: .flat,
            events: []
        ),
        AgentHookDef(
            name: "pi", displayName: "Pi", statusKey: "pi",
            configDir: ".pi/agent", configFile: "extensions/mosaic-session.ts", configDirEnvOverride: "PI_CODING_AGENT_DIR",
            sessionStoreSuffix: "pi", disableEnvVar: "MOSAIC_PI_HOOKS_DISABLED",
            hookMarker: "mosaic hooks pi", format: .flat,
            events: []
        ),
        AgentHookDef(
            name: "omp", displayName: "OMP", statusKey: "omp",
            configDir: ".omp/agent", configFile: "extensions/mosaic-omp-session.ts",
            createConfigDirIfMissing: true,
            configDirResolver: { MosaicCLI.resolvedOmpAgentDirectory().path },
            sessionStoreSuffix: "omp", disableEnvVar: "MOSAIC_OMP_HOOKS_DISABLED",
            hookMarker: "mosaic hooks omp", format: .flat,
            events: []
        ),
        AgentHookDef(
            name: "amp", displayName: "Amp", statusKey: "amp",
            configDir: ".config/amp", configFile: "plugins/mosaic-session.ts",
            sessionStoreSuffix: "amp", disableEnvVar: "MOSAIC_AMP_HOOKS_DISABLED",
            hookMarker: "mosaic hooks amp", format: .flat,
            events: []
        ),
        AgentHookDef(
            name: "cursor", displayName: "Cursor", statusKey: "cursor",
            configDir: ".cursor", configFile: "hooks.json", binaryName: "cursor-agent",
            sessionStoreSuffix: "cursor", disableEnvVar: "MOSAIC_CURSOR_HOOKS_DISABLED",
            hookMarker: "mosaic hooks cursor", format: .flat,
            events: [
                .init(agentEvent: "beforeSubmitPrompt", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "afterAgentResponse", mosaicSubcommand: "agent-response"),
                .init(agentEvent: "beforeShellExecution", mosaicSubcommand: "shell-exec"),
                .init(agentEvent: "afterShellExecution", mosaicSubcommand: "shell-done"),
            ],
        ...
        AgentHookDef(
            ...
            sessionStoreSuffix: "gemini", disableEnvVar: "MOSAIC_GEMINI_HOOKS_DISABLED",
            hookMarker: "mosaic hooks gemini", format: .nested(timeoutMs: 10000),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "BeforeAgent", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "AfterAgent", mosaicSubcommand: "stop"),
                .init(agentEvent: "SessionEnd", mosaicSubcommand: "session-end"),
            ],
            feedHookEvents: ["PreToolUse"]
        ),
        AgentHookDef(
            ...
            configDir: ".kiro/agents", configFile: "mosaic.json",
            configDirEnvOverride: "KIRO_HOME", configDirEnvOverrideSubpath: "agents",
            createConfigDirIfMissing: true, binaryName: "kiro-cli",
            sessionStoreSuffix: "kiro", disableEnvVar: "MOSAIC_KIRO_HOOKS_DISABLED",
            hookMarker: "mosaic hooks kiro", format: .kiroAgentJSON(timeoutMs: 5000),
            events: [
                .init(agentEvent: "agentSpawn", mosaicSubcommand: "session-start"),
                .init(agentEvent: "userPromptSubmit", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "stop", mosaicSubcommand: "stop"),
            ],
            ...
            postInstallNote: String(
                ...
                defaultValue: "Kiro applies these hooks only when run as the mosaic agent. Start Kiro with `kiro-cli chat --agent mosaic`, or make it the default with `kiro-cli settings chat.defaultAgent mosaic`."
            )
        ),
        AgentHookDef(
            ...
            sessionStoreSuffix: "antigravity", disableEnvVar: "MOSAIC_ANTIGRAVITY_HOOKS_DISABLED",
            hookMarker: "mosaic hooks antigravity", format: .antigravityJSON(timeoutSeconds: 10),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "PreInvocation", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "turn-completion", mosaicSubcommand: "stop"),
                .init(agentEvent: "Notification", mosaicSubcommand: "notification"),
                .init(agentEvent: "SessionEnd", mosaicSubcommand: "session-end"),
            ],
            aliases: ["agy"],
        ...
        AgentHookDef(
            ...
            sessionStoreSuffix: "rovodev", disableEnvVar: "MOSAIC_ROVODEV_HOOKS_DISABLED",
            hookMarker: "mosaic hooks rovodev", format: .rovoDevYAML,
            events: [
                .init(agentEvent: "on_complete", mosaicSubcommand: "stop"),
                .init(agentEvent: "on_error", mosaicSubcommand: "stop"),
                .init(agentEvent: "on_tool_permission", mosaicSubcommand: "prompt-submit"),
            ],
            aliases: ["rovo"]
        ),
        AgentHookDef(
            ...
            binaryName: "hermes",
            sessionStoreSuffix: "hermes-agent", disableEnvVar: "MOSAIC_HERMES_AGENT_HOOKS_DISABLED",
            hookMarker: "mosaic hooks hermes-agent", format: .hermesAgentYAML,
            events: [
                .init(agentEvent: "on_session_start", mosaicSubcommand: "session-start"),
                .init(agentEvent: "pre_llm_call", mosaicSubcommand: "prompt-submit"),
                .init(agentEvent: "post_llm_call", mosaicSubcommand: "agent-response"),
                .init(agentEvent: "pre_approval_request", mosaicSubcommand: "notification"),
                .init(agentEvent: "post_approval_response", mosaicSubcommand: "approval-response"),
                .init(agentEvent: "on_session_end", mosaicSubcommand: "session-end"),
                .init(agentEvent: "on_session_finalize", mosaicSubcommand: "session-finalize"),
                .init(agentEvent: "on_session_reset", mosaicSubcommand: "session-start"),
            ],
            sessionEndIsTurnBoundary: true,
        ...
        AgentHookDef(
            ...
            sessionStoreSuffix: "copilot", disableEnvVar: "MOSAIC_COPILOT_HOOKS_DISABLED",
            hookMarker: "mosaic hooks copilot", format: .nested(timeoutMs: 5000),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "Notification", mosaicSubcommand: "stop"),
                .init(agentEvent: "SessionEnd", mosaicSubcommand: "session-end"),
            ],
            feedHookEvents: ["PreToolUse"]
        ),
        AgentHookDef(
            ...
            sessionStoreSuffix: "codebuddy", disableEnvVar: "MOSAIC_CODEBUDDY_HOOKS_DISABLED",
            hookMarker: "mosaic hooks codebuddy", format: .nested(timeoutMs: 5000),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "Notification", mosaicSubcommand: "stop"),
        ...
        AgentHookDef(
            ...
            sessionStoreSuffix: "factory", disableEnvVar: "MOSAIC_FACTORY_HOOKS_DISABLED",
            hookMarker: "mosaic hooks factory", format: .nested(timeoutMs: 5000),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "Notification", mosaicSubcommand: "stop"),
        ...
        AgentHookDef(
            ...
            sessionStoreSuffix: "qoder", disableEnvVar: "MOSAIC_QODER_HOOKS_DISABLED",
            hookMarker: "mosaic hooks qoder", format: .nested(timeoutMs: 5000),
            events: [
                .init(agentEvent: "SessionStart", mosaicSubcommand: "session-start"),
                .init(agentEvent: "Stop", mosaicSubcommand: "stop"),
                .init(agentEvent: "SessionEnd", mosaicSubcommand: "session-end"),
    ...
    static func hookCommandString(for def: AgentHookDef, event: AgentHookDef.HookEvent) -> String {
        let command = "mosaic hooks \(def.name) \(event.mosaicSubcommand)"
        let inline: String
        if def.name == "codex", codexHookCanRunFireAndForget(event.mosaicSubcommand) {
            inline = codexFireAndForgetAgentHookShellCommand(command, for: def)
        } else {
            inline = agentHookShellCommand(command, for: def)
        }
        if def.name == "codex" {
            return codexPersistentHookScriptCommand(inline, eventTag: event.mosaicSubcommand)
        }
        return inline
    }

    /// Wraps a codex persistent hook command as a `#!/bin/sh` script file in the
    /// mosaic-owned hooks dir and returns its path. A bare executable path runs
    ...
    static func feedHookCommandString(for def: AgentHookDef, agentEvent: String) -> String {
        ...
        case .kiroAgentJSON:
            inline = exitTwoPropagatingAgentHookShellCommand(
                "mosaic hooks feed --source \(def.name) --event \(agentEvent)",
                for: def,
    ...
    private static let grokPinnedHookMarker = "mosaic-grok-hook-v2"
    private static let antigravityPinnedHookMarker = "mosaic-antigravity-hook-v2"
    ...
    private static func agentHookShellCommand(
        ...
        let routedArguments = command.hasPrefix("mosaic ") ? String(command.dropFirst("mosaic ".count)) : command
        let noOpSnippet = shellNoOpSnippet(noOpCommand)
        return "mosaic_cli=\"${MOSAIC_BUNDLED_CLI_PATH:-}\"; if [ -z \"$mosaic_cli\" ] || [ ! -x \"$mosaic_cli\" ]; then mosaic_cli=\"$(command -v mosaic 2>/dev/null || true)\"; fi; if [ -n \"$MOSAIC_SURFACE_ID\" ] && [ \"$\(def.disableEnvVar)\" != \"1\" ] && [ -n \"$mosaic_cli\" ]; then { if [ -n \"${MOSAIC_SOCKET_PATH:-}\" ]; then \"$mosaic_cli\" --socket \"$MOSAIC_SOCKET_PATH\" \(routedArguments); else \"$mosaic_cli\" \(routedArguments); fi; } || \(noOpSnippet); else \(noOpSnippet); fi"
    }
    ...
    private static func exitTwoPropagatingAgentHookShellCommand(
        ...
        let routedArguments = command.hasPrefix("mosaic ") ? String(command.dropFirst("mosaic ".count)) : command
        let noOpSnippet = shellNoOpSnippet(noOpCommand)
        return "mosaic_cli=\"${MOSAIC_BUNDLED_CLI_PATH:-}\"; if [ -z \"$mosaic_cli\" ] || [ ! -x \"$mosaic_cli\" ]; then mosaic_cli=\"$(command -v mosaic 2>/dev/null || true)\"; fi; if [ -n \"$MOSAIC_SURFACE_ID\" ] && [ \"$\(def.disableEnvVar)\" != \"1\" ] && [ -n \"$mosaic_cli\" ]; then if [ -n \"${MOSAIC_SOCKET_PATH:-}\" ]; then \"$mosaic_cli\" --socket \"$MOSAIC_SOCKET_PATH\" \(routedArguments); else \"$mosaic_cli\" \(routedArguments); fi; status=$?; if [ \"$status\" -eq 2 ]; then exit 2; fi; if [ \"$status\" -ne 0 ]; then \(noOpSnippet); fi; else \(noOpSnippet); fi"
    }
    ...
    private static func pinnedAgentHookShellCommand(
        ...
        let shellTraceExit = pinnedHookShellTraceCommand(
            ...
            routedArguments: routedArguments,
            socketPath: socketPath,
            statusExpression: "$mosaic_hook_status"
        )
        ...
        if let cliPath = pinnedAgentHookCLIPath() {
            ...
            dispatch = "if [ -x \(quotedCLIPath) ]; then \(primaryInvocation); elif command -v mosaic >/dev/null 2>&1; then \(fallbackInvocation); else \(noOpSnippet); fi"
        } else {
            dispatch = "command -v mosaic >/dev/null 2>&1 && \(fallbackInvocation) || \(noOpSnippet)"
        }
        return ": \(pinnedHookMarker(for: def)); \(shellTraceStart); printenv \(def.disableEnvVar) | grep -qx 1 && { \(shellTraceDisabled); \(noOpCommand); } || { \(dispatch); mosaic_hook_status=$?; \(shellTraceExit); exit $mosaic_hook_status; }"
    }
    ...
    private static func pinnedAgentHookCLIPath(
        ...
        if let bundledPath = normalizedHookInstallValue(env["MOSAIC_BUNDLED_CLI_PATH"]) {
    ...
    private static func pinnedAgentHookSocketPath(
        ...
        if let socketPath = normalizedHookInstallValue(env["MOSAIC_SOCKET_PATH"]) {
            return NSString(string: socketPath).expandingTildeInPath
        }
        guard let tag = normalizedHookInstallValue(env["MOSAIC_TAG"]) else {
            return nil
        }
        let slug = tag
            .lowercased()
        ...
        return "/tmp/mosaic-debug-\(slug).sock"
    }
    ...
    private static func pinnedHookShellTraceLogPath(socketPath: String?) -> String {
        ...
        if socketName.hasPrefix("mosaic-debug-"), socketName.hasSuffix(".sock") {
    ...
    static func isMosaicOwnedHookCommand(_ command: String, for def: AgentHookDef, includeLegacy: Bool = true) -> Bool {
        ...
        return includeLegacy && isLegacyMosaicOwnedHookCommand(command, for: def)
    }

    private static func isLegacyMosaicOwnedHookCommand(_ command: String, for def: AgentHookDef) -> Bool {
        // Codex also had older top-level codex-hook/feed-hook commands.
        // Other generic agents can have stale `mosaic hooks ...` files from
        // earlier integration attempts, and setup should be able to prune them.
        return legacyMosaicCommandTokenLists(from: command, for: def).contains { tokens in
            isLegacyMosaicOwnedHookTokens(tokens, for: def)
        }
    }

    private static func isLegacyMosaicOwnedHookTokens(_ tokens: [String], for def: AgentHookDef) -> Bool {
        guard !tokens.isEmpty,
              URL(fileURLWithPath: tokens[0]).lastPathComponent == "mosaic"
        else {
            return false
        }
    ...
    private static func legacyMosaicCommandTokenLists(from command: String, for def: AgentHookDef) -> [[String]] {
        if let bundledTokens = bundledCLIMosaicCommandTokenLists(from: command), !bundledTokens.isEmpty {
            return bundledTokens
        }

        let guardedPrefixes = [
            "[ -n \"$MOSAIC_SURFACE_ID\" ] && [ \"$\(def.disableEnvVar)\" != \"1\" ] && command -v mosaic >/dev/null 2>&1 && ",
            "[ \"$\(def.disableEnvVar)\" != \"1\" ] && command -v mosaic >/dev/null 2>&1 && ",
        ]
        let fallbackSuffix = " || echo '{}'"
        var body = command
        if def.name == "grok" {
            let grokPrefix = "printenv \(def.disableEnvVar) | grep -qx 1 && echo '{}' || { command -v mosaic >/dev/null 2>&1 && "
            let grokSuffix = " || echo '{}'; }"
    ...
    private static func bundledCLIMosaicCommandTokenLists(from command: String) -> [[String]]? {
        guard command.contains("MOSAIC_BUNDLED_CLI_PATH"),
              command.contains("mosaic_cli="),
              command.contains("command -v mosaic") else {
            return nil
        }

        let invocationPrefixes = [
            "\"$mosaic_cli\" --socket \"$MOSAIC_SOCKET_PATH\" ",
            "\"$mosaic_cli\" ",
        ]
        ...
        for prefix in invocationPrefixes {
            ...
            while let prefixRange = command.range(of: prefix, range: searchStart..<command.endIndex) {
                ...
                if !args.isEmpty,
                   ...
                   !args.contains("`") {
                    tokenLists.append(
                        ["mosaic"] + args.split(whereSeparator: { $0 == " " || $0 == "\t" }).map(String.init)
                    )
                }
    ...
    static func hookMarkers(for def: AgentHookDef) -> [String] {
        ...
        if def.name == "codex" {
            markers.append("mosaic codex-hook")
        }
        return markers
    }
    ...
    static func feedHookMarkers(for def: AgentHookDef) -> [String] {
        var markers = ["mosaic hooks feed --source"]
        if def.name == "codex" {
            markers.append("mosaic feed-hook --source")
        }
        return markers
    }
}
