...
extension MosaicCLI {
    ...
    func spawnDetachedAgentAutoName(
        ...
        let selfPath: String = {
            ...
            if let bundled = normalizedHookValue(env["MOSAIC_BUNDLED_CLI_PATH"]),
        ...
        var spawnEnv = env
        spawnEnv["MOSAIC_CLAUDE_HOOK_STATE_PATH"] = agentHookStatePath(sessionStoreSuffix: def.sessionStoreSuffix, env: env)
