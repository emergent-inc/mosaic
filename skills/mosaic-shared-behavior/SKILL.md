---
name: mosaic-shared-behavior
description: "Shared behavior and mutation-path rules for mosaic. Use when a behavior is exposed through multiple entrypoints such as keyboard shortcuts, command palette, context menu, CLI, settings, debug menu, optimistic UI, or tests that previously missed a bug."
---

# mosaic Shared Behavior
