...
```bash
mosaic browser surface:7 snapshot
mosaic browser surface:7 snapshot --interactive
mosaic browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
mosaic browser surface:7 click e6
mosaic browser surface:7 fill e10 "user@example.com"
mosaic browser surface:7 fill e11 "password123"
mosaic browser surface:7 click e12
```
...
mosaic browser surface:7 click e1
...
```bash
mosaic browser surface:7 wait --selector "#target" --timeout-ms 10000
mosaic browser surface:7 scroll --dy 400
mosaic browser surface:7 snapshot --interactive
```
...
```bash
mosaic browser surface:7 snapshot --selector "form#checkout" --interactive
```
