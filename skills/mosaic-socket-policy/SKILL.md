---
name: mosaic-socket-policy
description: "Socket command threading and focus policy for mosaic CLI/socket work. Use when adding or changing socket commands, CLI commands, telemetry commands, focus/select/open/close/send-key behavior, or automation that could steal app focus."
---

# mosaic Socket Policy
