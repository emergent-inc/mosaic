...
A `.swift` file added to `mosaicTests/` without matching project entries can be silently ignored by Xcode. Both targeted `xcodebuild test -only-testing:mosaicTests/<TestClass>` and bot reviews can pass with "Executed 0 tests".
