# Command Reference (mosaic Markdown)

## Opening a Markdown Panel

```bash
mosaic markdown open <path>
mosaic markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$MOSAIC_WORKSPACE_ID` |
...
mosaic markdown open ./plan.md
mosaic markdown open /Users/me/project/plan.md
```
