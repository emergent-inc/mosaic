...
mosaic markdown open plan.md

# Absolute path
mosaic markdown open /path/to/PLAN.md

# Target a specific workspace
mosaic markdown open design.md --workspace workspace:2
```
...
When creating a plan or task list, write it to a `.md` file and open it in mosaic:
...
```bash
# Open in the caller's workspace (default -- uses MOSAIC_WORKSPACE_ID)
mosaic markdown open plan.md

# Open in a specific workspace
mosaic markdown open plan.md --workspace workspace:2

# Open splitting from a specific surface
mosaic markdown open plan.md --surface surface:5

# Open in a specific window
mosaic markdown open plan.md --window window:1
```
