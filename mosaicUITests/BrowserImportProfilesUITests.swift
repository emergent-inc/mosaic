...
final class BrowserImportProfilesUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        capturePath = "/tmp/mosaic-ui-test-browser-import-\(UUID().uuidString).json"
        settingsOpenCapturePath = "/tmp/mosaic-ui-test-settings-open-\(UUID().uuidString).json"
    ...
    private func launchApp() -> XCUIApplication {
        ...
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_FIXTURE"] = #"{"browserName":"Helium","profiles":["You","austin"]}"#
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_DESTINATIONS"] = #"["Default"]"#
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_MODE"] = "capture-only"
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_CAPTURE_PATH"] = capturePath
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_HINT_VARIANT"] = "inlineStrip"
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_HINT_SHOW"] = "1"
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_HINT_DISMISSED"] = "0"
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_HINT_OPEN_BLANK_BROWSER"] = "1"
    ...
    private func launchAppForBlankImportHint() -> XCUIApplication {
        ...
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_HINT_DISMISSED"] = "0"
        app.launchEnvironment["MOSAIC_UI_TEST_BROWSER_IMPORT_HINT_OPEN_BLANK_BROWSER"] = "1"
        app.launchEnvironment["MOSAIC_UI_TEST_SETTINGS_OPEN_CAPTURE_PATH"] = settingsOpenCapturePath
        launchAndActivate(app)
