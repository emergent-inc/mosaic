...
final class AutomationSocketUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        diagnosticsPath = "/tmp/mosaic-ui-test-automation-socket-\(UUID().uuidString).json"
    ...
    func testSocketToggleDisablesAndEnables() {
        let app = configuredApp(mode: "mosaicOnly")
        app.launch()
        XCTAssertTrue(
    ...
    private func makeSkillFixtureRoot(skillNames: [String]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-ui-textbox-skills-\(UUID().uuidString)", isDirectory: true)
