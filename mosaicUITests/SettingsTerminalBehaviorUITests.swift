...
/// (`Sources/mosaicApp.swift`, the `Settings…` window) and in the
/// migrated `MosaicSettingsUI.TerminalSection`:
...
final class SettingsTerminalBehaviorUITests: SettingsUITestCase {
    ...
    private enum Subtitle {
        ...
        static let copyOff = "mosaic does not add system-clipboard copy on selection"
