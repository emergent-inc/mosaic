...
final class SidebarPullRequestInteractivityUITests: XCTestCase {
    ...
    private var pullRequestURL: String {
        "https://github.com/emergent-inc/mosaic/pull/\(pullRequestNumber)"
    }

    override func setUp() {
        super.setUp()
        continueAfterFailure = false
        socketPath = "/tmp/mosaic-ui-test-sidebar-pr-\(UUID().uuidString).sock"
    ...
    private func assertSidebarPullRequestClickFallsThrough(
        ...
        app.launchArguments += [
            ...
            "-browserOpenSidebarPullRequestLinksInMosaicBrowser", "true",
        ]
