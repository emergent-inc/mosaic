...
/// `Packages/macOS/MosaicSettingsUI/.../Sections/WorkspaceColorsSection.swift`
/// and `Packages/macOS/MosaicSettings/.../Keys/WorkspaceColorsCatalogSection.swift`):
///
...
//   mosaic.json, neither reachable from XCUITest without a seam. Verifying
