...
[Завантажити cmux NIGHTLY](https://github.com/emergent-inc/cmux/releases/download/nightly/cmux-nightly-macos.dmg)
...
Повідомляйте про помилки нічних збірок на [GitHub Issues](https://github.com/emergent-inc/cmux/issues) або в [#nightly-bugs у Discord](https://discord.gg/xsgFEVrWCZ).
...
Так, cmux безкоштовний у використанні. Вихідний код доступний на [GitHub](https://github.com/emergent-inc/cmux).

### Як я можу підтримати cmux?

cmux безкоштовний та з відкритим кодом, і завжди таким буде. Якщо ви хочете підтримати розробку та отримати ранній доступ до того, що буде далі, включно з cmux AI, додатком iOS та Cloud VMs, перегляньте [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition).

### У мене є запит на функцію або я знайшов помилку?

Ми хочемо про це почути. Відкрийте [issue](https://github.com/emergent-inc/cmux/issues) або [pull request](https://github.com/emergent-inc/cmux/pulls) на GitHub, або [напишіть нам](mailto:contact@emergent.inc?subject=cmux%20feature%20request).
...
<a href="https://star-history.com/#emergent-inc/cmux&Date">
 <picture>
   ...
   <img alt="Діаграма історії зірок" src="https://api.star-history.com/svg?repos=emergent-inc/cmux&type=Date" width="600" />
 </picture>
</a>
...
- Підписуйтесь на нас у X для оновлень [@emergentinc](https://x.com/emergentinc), [@lawrencecchen](https://x.com/lawrencecchen) та [@austinywang](https://x.com/austinywang)
- Приєднуйтесь до обговорень у [Discord](https://discord.gg/xsgFEVrWCZ)
- Створюйте та беріть участь у [GitHub issues](https://github.com/emergent-inc/cmux/issues) та [обговореннях](https://github.com/emergent-inc/cmux/discussions)
...
Якщо ваша організація не може дотримуватися GPL, доступна комерційна ліцензія. Зв'яжіться з [contact@emergent.inc](mailto:contact@emergent.inc) для деталей.
