...
[تحميل cmux NIGHTLY](https://github.com/emergent-inc/cmux/releases/download/nightly/cmux-nightly-macos.dmg)
...
أبلغ عن أخطاء الإصدارات الليلية على [GitHub Issues](https://github.com/emergent-inc/cmux/issues) أو في [#nightly-bugs على Discord](https://discord.gg/xsgFEVrWCZ).
...
نعم. المهارات هي سير عمل قابل لإعادة الاستخدام يمكنك منحه لأي وكيل يعمل في cmux، لأمور مثل التحكم عبر CLI وأتمتة مساحات العمل والإعدادات وأسطح المتصفح. تصفّح المجموعة المفتوحة على [cmux-skills](https://github.com/emergent-inc/cmux-skills)، أو اقرأ [وثائق المهارات](https://cmux.com/docs/skills).
...
نعم، cmux مجاني الاستخدام. الكود المصدري متاح على [GitHub](https://github.com/emergent-inc/cmux).

### كيف يمكنني دعم cmux؟

cmux مجاني ومفتوح المصدر، وسيظل كذلك دائمًا. إذا كنت ترغب في دعم التطوير والحصول على وصول مبكر لما هو قادم، بما في ذلك cmux AI وتطبيق iOS وCloud VMs، فاطّلع على [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition).

### لدي طلب ميزة أو وجدت خطأ؟

نريد أن نسمعه. افتح [issue](https://github.com/emergent-inc/cmux/issues) أو [pull request](https://github.com/emergent-inc/cmux/pulls) على GitHub، أو [راسلنا عبر البريد الإلكتروني](mailto:contact@emergent.inc?subject=cmux%20feature%20request).
...
- تابعنا على X للتحديثات [@emergentinc](https://x.com/emergentinc)، [@lawrencecchen](https://x.com/lawrencecchen)، و[@austinywang](https://x.com/austinywang)
- انضم إلى المحادثة على [Discord](https://discord.gg/xsgFEVrWCZ)
- أنشئ وشارك في [قضايا GitHub](https://github.com/emergent-inc/cmux/issues) و[المناقشات](https://github.com/emergent-inc/cmux/discussions)
...
إذا لم تستطع مؤسستك الامتثال لـ GPL، فهناك ترخيص تجاري متاح. تواصل مع [contact@emergent.inc](mailto:contact@emergent.inc) للتفاصيل.
