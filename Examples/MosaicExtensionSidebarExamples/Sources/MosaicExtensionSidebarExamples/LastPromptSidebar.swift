...
public struct LastPromptSidebar: MosaicSidebarProvider {
    public let descriptor = MosaicSidebarProviderDescriptor(
        id: "com.example.mosaic.sidebar.last-prompt",
    ...
    private func promptSubtitle(_ workspace: MosaicSidebarProviderWorkspace) -> MosaicSidebarProviderText? {
    ...
    private func promptTrailingText(_ workspace: MosaicSidebarProviderWorkspace) -> MosaicSidebarProviderText? {
