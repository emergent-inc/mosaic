...
public struct AttentionQueueSidebar: MosaicSidebarProvider {
    public let descriptor = MosaicSidebarProviderDescriptor(
        id: "com.example.mosaic.sidebar.attention-queue",
    ...
    private func needsAttention(_ workspace: MosaicSidebarProviderWorkspace) -> Bool {
    ...
    private func rowSubtitle(_ workspace: MosaicSidebarProviderWorkspace) -> MosaicSidebarProviderText? {
        ...
        return trimmed(workspace.customDescription).map(MosaicSidebarProviderText.plain)
    }

    private func hasRemoteTarget(_ workspace: MosaicSidebarProviderWorkspace) -> Bool {
