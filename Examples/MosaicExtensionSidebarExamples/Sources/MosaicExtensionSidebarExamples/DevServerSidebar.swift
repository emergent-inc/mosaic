...
public struct DevServerSidebar: MosaicSidebarProvider {
    public let descriptor = MosaicSidebarProviderDescriptor(
        id: "com.example.mosaic.sidebar.dev-servers",
    ...
    private func hasServerSignal(_ workspace: MosaicSidebarProviderWorkspace) -> Bool {
    ...
    private func serverSubtitle(_ workspace: MosaicSidebarProviderWorkspace) -> MosaicSidebarProviderText? {
        if !workspace.listeningPorts.isEmpty {
