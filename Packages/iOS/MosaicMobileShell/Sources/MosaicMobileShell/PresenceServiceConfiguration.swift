...
extension PresenceClient {
    /// Env override, mirroring the Mac's `MOSAIC_PRESENCE_BASE_URL`.
    public static let serviceURLEnvKey = "MOSAIC_PRESENCE_BASE_URL"
    ...
    /// `MOSAIC_PRESENCE_BASE_URL`) to point the build at a per-developer isolated
    ...
    /// instance.
    public static let serviceURLInfoPlistKey = "MosaicPresenceBaseURL"
    /// The dev/staging worker (dev Stack project); see workers/presence/README.md.
    public static let debugDefaultServiceURL = "https://mosaic-presence-dev.debussy.workers.dev"
    ...
    public static let productionServiceURL = "https://presence.mosaic.dev"
