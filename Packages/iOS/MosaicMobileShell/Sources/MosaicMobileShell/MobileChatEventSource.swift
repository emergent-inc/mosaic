...
/// The iOS implementation of ``MosaicAgentChat/ChatEventSource``: adapts the
...
/// ``MosaicAgentChat/ChatConversationStore`` resubscribes through its `run()`
/// loop.
public actor MobileChatEventSource: ChatEventSource {
    ...
    ///
    /// Not part of ``MosaicAgentChat/ChatEventSource`` (which is scoped to one
