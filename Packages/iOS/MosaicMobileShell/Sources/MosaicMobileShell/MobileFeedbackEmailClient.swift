...
/// Default ``MobileFeedbackEmailSubmitting`` that POSTs to the mosaic web
...
public struct MobileFeedbackEmailClient: MobileFeedbackEmailSubmitting {
    ...
    /// - Parameters:
    ///   - apiBaseURL: The mosaic web API base URL with no trailing slash (e.g.
    ///     `https://mosaic.dev`). `/api/feedback` is appended.
