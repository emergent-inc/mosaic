...
@Suite struct IOSBuildScopedPairedMacStoreTests {
    ...
    @Test func currentScopePrefersInstalledBundleSuffix() {
        #expect(MobileIOSBuildScope.current(infoDictionary: ["MosaicDevTag": "feat"], bundleIdentifier: "dev.mosaic.ios.other")?.value == "other")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["MosaicDevTag": ""], bundleIdentifier: "dev.mosaic.ios.agent")?.value == "agent")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["MosaicDevTag": ""], bundleIdentifier: "dev.mosaic.ios") == nil)
