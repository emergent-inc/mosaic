...
private let analyticsUploadLog = Logger(subsystem: "dev.mosaic.ios", category: "analytics-upload")

/// An ``AnalyticsUploading`` that POSTs batches to the mosaic web analytics proxy.
///
...
public struct HTTPAnalyticsUploader: AnalyticsUploading {
    ...
    ///
    /// - Parameters:
    ///   - apiBaseURL: The mosaic web API base URL, no trailing slash (resolved at
