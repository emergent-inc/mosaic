...
@Suite struct QRCodeFrameSelectionTests {
    private let accepted = "mosaic-ios://attach?v=2&r=100.64.0.5:52341"
    private let acceptsPairing: @Sendable (String) -> Bool = { $0.hasPrefix("mosaic-ios://") }
    ...
    @Test func firstAcceptedCodeWinsAmongMultiple() {
        let other = "mosaic-ios://attach?v=2&r=100.64.0.9:1024"
        let candidates = [
            QRCodeFrameCandidate(isQRCode: true, stringValue: accepted),
