...
public final class MobileDisplaySettings {
    ...
    private static let wrapWorkspaceTitlesKey = "mosaic.mobile.wrapWorkspaceTitles"
    private static let workspacePreviewLineCountKey = "mosaic.mobile.workspacePreviewLineCount"
    private static let unreadIndicatorLeftShiftKey = "mosaic.mobile.debug.unreadIndicatorLeftShift.v2"
    private static let profilePictureLeftShiftKey = "mosaic.mobile.debug.profilePictureLeftShift"
    private static let profilePictureSizeKey = "mosaic.mobile.debug.profilePictureSize"
