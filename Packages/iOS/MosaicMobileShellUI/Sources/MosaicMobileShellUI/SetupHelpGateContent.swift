...
struct SetupHelpGateContent {
    ...
    /// Founders Edition page: mosaic for Mac download plus TestFlight enrollment,
    /// used by the "Run mosaic on your Mac" gate.
    private static let setupHelpMacDownloadURL = URL(string: "https://github.com/emergent-inc/mosaic#founders-edition")!
