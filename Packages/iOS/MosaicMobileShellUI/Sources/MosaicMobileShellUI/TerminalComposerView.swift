...
struct TerminalComposerView: View {
    ...
    init(store: MosaicMobileShellStore, terminalID: String, requestHeightRemeasure: @escaping () -> Void) {
        self.store = store
    ...
    private nonisolated static let maxImageBytes = MosaicMobileShellStore.maxPendingAttachmentImageBytes
    ...
    private static let maxAttachmentCount = MosaicMobileShellStore.maxPendingAttachmentCount
    ...
    private static let maxTotalAttachmentBytes = MosaicMobileShellStore.maxPendingAttachmentTotalBytes
    ...
    static var transferRepresentation: some TransferRepresentation {
        FileRepresentation(contentType: .image) { imported in
            ...
            let destination = FileManager.default.temporaryDirectory
                .appendingPathComponent("mosaic-composer-import-" + name)
