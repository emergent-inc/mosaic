...
#if os(iOS)
/// SwiftUI host for the ``MosaicMobileCamera`` QR-capture controller.
///
/// Owns one ``QRCodeScanStream`` per presentation, mounts the package's
/// ``QRCodeCaptureController``, and forwards accepted `mosaic-ios://` codes to
