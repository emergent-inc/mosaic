...
struct GhosttySurfaceRepresentable: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, GhosttySurfaceViewDelegate {
        let surfaceID: String
        weak var store: MosaicMobileShellStore?
        ...
        init(surfaceID: String, store: MosaicMobileShellStore) {
        ...
        @MainActor
        private func makeComposerController(store: MosaicMobileShellStore) -> UIHostingController<TerminalComposerView> {
