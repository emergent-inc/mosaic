...
public struct MosaicAuthState: Equatable, Sendable {
    /// Whether a user session is currently active.
    public let isAuthenticated: Bool
    /// The signed-in (or cached) user, if any.
    public let currentUser: MosaicAuthUser?
    ...
    public init(isAuthenticated: Bool, currentUser: MosaicAuthUser?, isRestoringSession: Bool) {
    ...
    public static func primed(
        ...
        fixtureUser: MosaicAuthUser?,
        autoLoginCredentials: MosaicAuthAutoLoginCredentials?,
        cachedUser: MosaicAuthUser?,
        hasTokens: Bool,
        mockUser: MosaicAuthUser
    ) -> Self {
