...
public struct MosaicAuthConfig: Equatable, Sendable {
    ...
    ///     injected defaults.
    ///   - developmentProjectId: Default project id for ``MosaicAuthEnvironment/development``.
    ///   - productionProjectId: Default project id for ``MosaicAuthEnvironment/production``.
