...
///
/// Backed by an injected ``MosaicAuthKeyValueStore`` (production: `UserDefaults`)
...
/// thread-safe, matching ``MosaicAuthSessionCache`` and ``MosaicAuthIdentityStore``.
public final class MosaicAuthTeamSelectionStore: @unchecked Sendable {
