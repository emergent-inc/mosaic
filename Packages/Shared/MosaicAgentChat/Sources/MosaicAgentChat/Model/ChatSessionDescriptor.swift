...
public struct ChatSessionDescriptor: Identifiable, Sendable, Equatable, Codable {
    ...
    /// The mosaic workspace the session's terminal belongs to, when known.
    public let workspaceID: String?

    /// The mosaic terminal surface hosting the session, when known. Required
    ...
    ///   - workspaceID: Owning mosaic workspace when known.
    ///   - terminalID: Hosting mosaic terminal surface when known.
