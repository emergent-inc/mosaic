...
private let syncStoreLog = Logger(subsystem: "mosaic.com.emergent.app", category: "MosaicSyncStore")
...
public actor MosaicSyncStore: MosaicSyncStoring {
    ...
    /// The default on-disk location, `mosaic-sync.sqlite3` next to the paired-Mac
    /// db under Application Support/mosaic.
    public static func defaultDatabaseURL(fileManager: FileManager = .default) throws -> URL {
        ...
        let dir = appSupport.appendingPathComponent("mosaic", isDirectory: true)
        if !fileManager.fileExists(atPath: dir.path) {
            try fileManager.createDirectory(at: dir, withIntermediateDirectories: true)
        }
        return dir.appendingPathComponent("mosaic-sync.sqlite3")
    }
    ...
    private func runMigrations() throws {
        ...
        case 1:
            break
        default:
            throw MosaicSyncStoreError.unknownSchemaVersion(Int(version))
        }
    }
