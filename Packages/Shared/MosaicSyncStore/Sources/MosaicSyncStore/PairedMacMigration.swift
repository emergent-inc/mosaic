...
/// `MosaicSyncStore` `devices` collection as PROVISIONAL records (`rev == 0`), so
...
public struct PairedMacMigration: Sendable {
    ...
    private let syncStore: any MosaicSyncStoring

    public init(pairedStore: any MobilePairedMacStoring, syncStore: any MosaicSyncStoring) {
