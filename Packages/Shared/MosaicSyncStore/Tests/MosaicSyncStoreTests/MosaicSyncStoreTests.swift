...
func makeStore() throws -> (MosaicSyncStore, URL) {
    let dir = FileManager.default.temporaryDirectory
        .appendingPathComponent(UUID().uuidString, isDirectory: true)
    try FileManager.default.createDirectory(at: dir, withIntermediateDirectories: true)
    let store = try MosaicSyncStore(databaseURL: dir.appendingPathComponent("mosaic-sync.sqlite3"))
    return (store, dir)
}
...
@Suite struct MosaicSyncStoreApplyTests {
