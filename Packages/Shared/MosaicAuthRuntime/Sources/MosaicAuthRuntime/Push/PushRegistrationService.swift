...
private let pushLog = Logger(subsystem: "ai.emergent.inc.mosaic", category: "push")

/// Owns the push opt-in state and the device-token sync with the mosaic web API.
///
...
public actor PushRegistrationService: PushRegistering {
    ...
    private static let cachedTokenKey = "mosaic.notifications.deviceTokenHex"
