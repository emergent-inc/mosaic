...
@Suite struct GitSlugAndConfigTests {
    @Test(arguments: [
        "git@github.com:emergent-inc/mosaic.git",
        "ssh://git@github.com/emergent-inc/mosaic.git",
        "https://github.com/emergent-inc/mosaic.git",
        "http://github.com/emergent-inc/mosaic",
        "git://github.com/emergent-inc/mosaic.git",
        "https://github.com/emergent-inc/mosaic",
    ])
    func parsesGitHubRemoteForms(url: String) {
        #expect(GitMetadataService.githubRepositorySlug(fromRemoteURL: url) == "emergent-inc/mosaic")
    }
