...
/// The user-visible kind of a mosaic sidebar surface.
public enum MosaicSidebarSurfaceKind: String, Codable, CaseIterable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self = MosaicSidebarSurfaceKind(rawValue: rawValue) ?? .unknown
    }
}

/// A sidebar surface exposed to mosaic extensions.
public struct MosaicSidebarSurface: Codable, Equatable, Identifiable, Sendable {
    /// The stable surface identifier.
    public var id: UUID
    /// The current surface title.
    public var title: String
    /// The kind of surface.
    public var kind: MosaicSidebarSurfaceKind
    ...
    public init(
        id: UUID,
        title: String,
        kind: MosaicSidebarSurfaceKind = .unknown,
    ...
    public func filtered(for scopes: some Sequence<MosaicExtensionScope>) -> MosaicSidebarSurface {
