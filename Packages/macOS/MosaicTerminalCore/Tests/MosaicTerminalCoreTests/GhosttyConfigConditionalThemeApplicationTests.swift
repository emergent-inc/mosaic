...
/// Regression coverage for https://github.com/emergent-inc/mosaic/issues/6411.
///
/// mosaic paints the terminal background from its host layer
...
/// cross-side fell back to the other appearance's theme, mosaic painted a light
...
@Suite struct GhosttyConfigConditionalThemeApplicationTests {
    ...
    private func makeThemesRoot() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-6411-\(UUID().uuidString)", isDirectory: true)
