/// A per-window mosaic configuration store that can re-read its backing file.
///
/// The app target's `MosaicConfigStore` conforms to this so
/// `MosaicConfigStoreReloadCoordinator` can drive reloads without depending on the
...
@MainActor
public protocol MosaicConfigStoreReloading: AnyObject {
...
@MainActor
public protocol MosaicConfigStoreReloadEnvironment: AnyObject {
    ...
    var reloadableConfigStores: [any MosaicConfigStoreReloading] { get }
