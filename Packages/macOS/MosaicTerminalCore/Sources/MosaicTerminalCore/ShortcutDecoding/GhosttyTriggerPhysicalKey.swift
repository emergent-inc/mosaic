...
/// keys mosaic maps to a menu-style shortcut glyph.
///
...
/// package without importing GhosttyKit. Any Ghostty physical key mosaic does not
...
public enum GhosttyTriggerPhysicalKey: String, Sendable, Equatable, Hashable, CaseIterable {
    ...
    /// The menu-style glyph mosaic renders for this physical key.
    ///
