...
// Test-only stand-ins for the libghostty symbols referenced by MosaicTerminal
// and MosaicTerminalCore object files. SwiftPM cannot link the GhosttyKit macOS
