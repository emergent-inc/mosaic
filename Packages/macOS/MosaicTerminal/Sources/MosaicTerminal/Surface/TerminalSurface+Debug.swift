...
extension TerminalSurface {
...
#if DEBUG
    static let surfaceLogPath = "/tmp/mosaic-ghostty-surface.log"
    static let sizeLogPath = "/tmp/mosaic-ghostty-size.log"
    ...
    static func sizeLog(_ message: String) {
        ...
        guard env["MOSAIC_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] == "1" else { return }
        let timestamp = ISO8601DateFormatter().string(from: Date())
        let line = "[\(timestamp)] \(message)\n"
