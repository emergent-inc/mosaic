...
public final class WindowGlassEffect: WindowGlassEffectManaging {
    static let backgroundIdentifier = NSUserInterfaceItemIdentifier("mosaic.windowGlassBackground")
    static let rootIdentifier = NSUserInterfaceItemIdentifier("mosaic.windowGlassRoot")
    static let foregroundContainerViewIdentifier = NSUserInterfaceItemIdentifier("mosaic.windowGlassForeground")
