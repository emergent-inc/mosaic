...
/// Runs the bundled mosaic CLI against the app's control socket to route a
...
/// that made `MosaicProcess.CommandRunner` a stateless struct). The legacy
...
public struct MultiWindowRouter: MultiWindowRouting, Sendable {
    ...
    /// - Parameters:
    ///   - cliURL: The bundled mosaic CLI executable.
