...
public final class NotificationDeliveryCoordinator {
    ...
    func notificationCategories() -> Set<UNNotificationCategory> {
        ...
        let permissionCategories = feedPermissionNotificationCategoryIds().map { categoryId in
            ...
            if categoryId.contains("Once") || categoryId == "MosaicFeedPermission" {
                actions.append(permissionOnceAction)
            }
            if categoryId.contains("Always") || categoryId == "MosaicFeedPermission" {
    ...
    private func feedPermissionNotificationCategoryIds() -> [String] {
        [
            "MosaicFeedPermission",
            "MosaicFeedPermissionDeny",
            "MosaicFeedPermissionOnce",
            "MosaicFeedPermissionAlways",
            "MosaicFeedPermissionAll",
            "MosaicFeedPermissionOnceAlways",
            "MosaicFeedPermissionOnceAll",
            "MosaicFeedPermissionAlwaysAll",
            "MosaicFeedPermissionOnceAlwaysAll",
        ]
    }
    ...
    private func handleFeedNotificationResponse(_ response: NotificationDeliveryResponse) -> Bool {
        ...
        guard categoryId.hasPrefix("MosaicFeedPermission")
