...
struct NotificationDeliveryCoordinatorTests {
    ...
    func configureInstallsCategoriesAndDelegate() throws {
        ...
        let fullPermission = try #require(categories["MosaicFeedPermissionOnceAlwaysAll"])
        ...
        let denyOnlyPermission = try #require(categories["MosaicFeedPermissionDeny"])
        #expect(denyOnlyPermission.actions.map(\.identifier) == ["feed.permission.deny"])

        let exitPlan = try #require(categories["MosaicFeedExitPlan"])
        ...
        let question = try #require(categories["MosaicFeedQuestion"])
    ...
    func feedPermissionAlwaysFallsBackToOnce() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            categoryIdentifier: "MosaicFeedPermissionOnceAlways",
    ...
    func feedPermissionUnsupportedModeDoesNotReply() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            categoryIdentifier: "MosaicFeedPermissionAll",
    ...
    func feedMissingRequestIdIsConsumed() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            categoryIdentifier: "MosaicFeedQuestion",
    ...
    func terminalDefaultClickActionPerformsAndMarksRead() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            ...
            userInfo: [
                ...
                "mosaicClickAction": "revealInFinder",
                "mosaicRevealInFinderPath": "/tmp/report.txt",
            ]
        ))
