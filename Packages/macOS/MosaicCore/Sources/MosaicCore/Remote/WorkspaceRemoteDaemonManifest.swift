...
/// The release manifest describing downloadable mosaicd-remote daemon binaries
...
public struct WorkspaceRemoteDaemonManifest: Decodable, Equatable, Sendable {
    ...
    /// mosaic app version the manifest was generated for.
...
extension WorkspaceRemoteDaemonManifest {
    ...
    /// JSON (`MosaicRemoteDaemonManifestJSON`); wire-pinned.
    public static let infoDictionaryKey = "MosaicRemoteDaemonManifestJSON"
