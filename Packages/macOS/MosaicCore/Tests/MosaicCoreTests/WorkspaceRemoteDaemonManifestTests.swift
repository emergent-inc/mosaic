...
struct WorkspaceRemoteDaemonManifestTests {
    private let manifestJSON = """
    {
      "schemaVersion": 1,
      "appVersion": "0.20.0",
      "releaseTag": "mosaicd-remote-v0.20.0",
      "releaseURL": "https://github.com/emergent-inc/mosaic/releases/tag/mosaicd-remote-v0.20.0",
      ...
      "entries": [
        {
          ...
          "downloadURL": "https://example.invalid/mosaicd-remote-linux-amd64",
          "sha256": "abc123"
        },
        {
          "goOS": "darwin",
          "goArch": "arm64",
          "assetName": "mosaicd-remote-darwin-arm64",
          "downloadURL": "https://example.invalid/mosaicd-remote-darwin-arm64",
          "sha256": "def456"
        }
      ]
    }
    ...
    func entryLookup() throws {
        ...
        #expect(manifest.entry(goOS: "darwin", goArch: "arm64")?.assetName == "mosaicd-remote-darwin-arm64")
    ...
    func decodesFromInfoDictionary() throws {
        ...
        #expect(WorkspaceRemoteDaemonManifest.infoDictionaryKey == "MosaicRemoteDaemonManifestJSON")
        #expect(manifest.releaseTag == "mosaicd-remote-v0.20.0")
