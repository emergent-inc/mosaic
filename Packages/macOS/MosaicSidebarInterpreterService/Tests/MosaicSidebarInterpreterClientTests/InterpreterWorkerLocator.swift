...
/// Locates the built `mosaic-sidebar-interpreter` worker executable so the client
...
func interpreterWorkerURL() -> URL {
    builtExecutableURL(named: "mosaic-sidebar-interpreter")
}

/// Locates the built `mosaic-sidebar-render-fixture` protocol fixture for the
/// `RenderWorkerClient` supervision tests (same lookup rules as the worker).
func renderFixtureURL() -> URL {
    builtExecutableURL(named: "mosaic-sidebar-render-fixture")
}
...
private func builtExecutableURL(named workerName: String) -> URL {
    ...
    // <package>/Tests/MosaicSidebarInterpreterClientTests/<thisFile>
