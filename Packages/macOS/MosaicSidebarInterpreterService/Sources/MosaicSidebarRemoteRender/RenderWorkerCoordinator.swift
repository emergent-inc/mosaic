...
final class RenderWorkerCoordinator {
    ...
    /// Stderr diagnostics, enabled with `MOSAIC_RENDER_WORKER_DEBUG=1` in the
    ...
    private let debugEnabled = ProcessInfo.processInfo.environment["MOSAIC_RENDER_WORKER_DEBUG"] == "1"
