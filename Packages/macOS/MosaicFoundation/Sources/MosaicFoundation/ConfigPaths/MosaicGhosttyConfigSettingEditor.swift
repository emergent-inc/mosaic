...
/// Reads and writes mosaic's numeric Ghostty config settings (sidebar and
...
public struct MosaicGhosttyConfigSettingEditor {
    ...
    /// The smallest sidebar font size mosaic allows.
    public static let minSidebarFontSize = 10.0
    /// The largest sidebar font size mosaic allows.
    ...
    /// The smallest surface-tab-bar font size mosaic allows.
    public static let minSurfaceTabBarFontSize = 8.0
    /// The largest surface-tab-bar font size mosaic allows.
