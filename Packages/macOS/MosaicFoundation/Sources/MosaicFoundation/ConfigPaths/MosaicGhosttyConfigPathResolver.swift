...
/// Resolves which mosaic-managed Ghostty config file under Application Support is
...
public struct MosaicGhosttyConfigPathResolver {
    /// The bundle identifier of the released mosaic app, used as the canonical
    ...
    /// The path mosaic writes edits to: always `config.ghostty` under the active
    ...
    /// The ordered list of mosaic-managed config files to load, applying the
