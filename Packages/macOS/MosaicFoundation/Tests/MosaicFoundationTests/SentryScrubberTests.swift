...
@Suite struct SentryScrubberTests {
    ...
    @Test func redactsInjectedHomeDirectory() {
        #expect(
            scrubber.scrub("loaded /Users/lawrence/.config/mosaic/mosaic.json")
                == "loaded /Users/<redacted>/.config/mosaic/mosaic.json"
        )
    }
    ...
    @Test func redactsAnyUsersPathEvenWhenNotTheRuntimeHome() {
        ...
        #expect(
            scrubber.scrub("/Users/buildbot/work/mosaic/Sources/AppDelegate.swift")
                == "/Users/<redacted>/work/mosaic/Sources/AppDelegate.swift"
        )
    }

    @Test func redactsLinuxHomePaths() {
        #expect(
            scrubber.scrub("at /home/runner/mosaic/main.swift line 12")
                == "at /home/<redacted>/mosaic/main.swift line 12"
        )
    }
    ...
    @Test func leavesSystemPathsUntouched() {
        let input = "/usr/lib/foo /System/Library/bar /Applications/mosaic.app"
