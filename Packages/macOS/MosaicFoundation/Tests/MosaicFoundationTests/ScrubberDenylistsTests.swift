...
@Suite struct ScrubberDenylistsTests {
    ...
    static let sensitiveKeys: [String] = [
        ...
        "_xsrf", "XSRF-TOKEN",
        // PII (mosaic runs sendDefaultPii = false)
    ...
    /// representative secrets/PII (relay `@common` corpora plus mosaic's own); each
    ...
    static let valueRedactions: [(input: String, expected: String)] = [
        ...
        // @urlauth equivalent (mosaic redactURLCredentials) — userinfo stripped.
        ...
        // mosaic-original provider key / JWT / AWS (exceed relay).
    ...
    /// inversion: relay redacts group 1 = body, mosaic redacts the whole match).
    ...
    static let preservedStrings: [String] = [
        // UUIDs mosaic logs constantly (workspace/surface ids). @uuid intentionally not ported.
        ...
        "mosaic DEV build 1234567890 v2",
