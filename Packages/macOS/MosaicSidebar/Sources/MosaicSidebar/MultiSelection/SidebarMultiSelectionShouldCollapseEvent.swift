...
public struct SidebarMultiSelectionShouldCollapseEvent: Sendable {
    /// The legacy notification name (`mosaic.sidebarMultiSelectionShouldCollapse`).
    public static let notificationName = Notification.Name("mosaic.sidebarMultiSelectionShouldCollapse")
