...
public struct SidebarMultiSelectionDidHideEvent: Sendable {
    /// The legacy notification name (`mosaic.sidebarMultiSelectionDidHide`).
    public static let notificationName = Notification.Name("mosaic.sidebarMultiSelectionDidHide")
