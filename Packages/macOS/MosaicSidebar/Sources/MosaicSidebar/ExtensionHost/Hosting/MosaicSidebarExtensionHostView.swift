...
@_spi(MosaicHostTransport) public import MosaicExtensionKit
public import Foundation
public import SwiftUI

@available(macOS 14.0, *)
/// SwiftUI bridge that hosts a sidebar extension scene through ExtensionKit.
@_spi(MosaicHostTransport) public struct MosaicSidebarExtensionHostView: NSViewControllerRepresentable {
    ...
    @_spi(MosaicHostTransport) public final class Coordinator: NSObject, EXHostViewControllerDelegate {
    ...
    public init(
        ...
        sceneID: String = MosaicSidebarExtensionPoint.defaultSceneID,
