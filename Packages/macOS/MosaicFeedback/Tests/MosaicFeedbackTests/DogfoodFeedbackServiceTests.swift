...
struct DogfoodFeedbackServiceTests {
    private func makeService(
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-dogfood-test-\(UUID().uuidString)", isDirectory: true)
    ...
    func writesBundle() async throws {
        ...
        #expect(manifest?["schema"] as? String == "mosaic.dogfood.feedback.v1")
    ...
    func prunesOldBundles() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-dogfood-prune-\(UUID().uuidString)", isDirectory: true)
