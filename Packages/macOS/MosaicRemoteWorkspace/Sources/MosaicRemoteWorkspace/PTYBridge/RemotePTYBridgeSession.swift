internal import MosaicRemoteDaemon
...
extension RemotePTYBridgeServer {
    ...
    final class Session: @unchecked Sendable {
        ...
        private let rpcQueue = DispatchQueue(label: "com.mosaic.remote-ssh.pty-bridge.rpc.\(UUID().uuidString)", qos: .userInitiated)
        ...
        func userFacingBridgeErrorMessage(_ error: any Error) -> String {
            ...
            // See https://github.com/emergent-inc/mosaic/issues/5185.
