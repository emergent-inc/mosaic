...
import Foundation
import Testing
@testable import MosaicSwiftRenderUI
...
struct CustomSidebarValidationTests {
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("mosaic-sidebar-validation-\(UUID().uuidString)", isDirectory: true)
    ...
    private static let richSidebarContext: [String: SwiftValue] = [
        ...
        "selectedTitle": .string("mosaic"),
        "selectedId": .string("workspace-mosaic"),
        "unreadTotal": .int(4),
        "clock": .object([
        ...
        "workspaces": .array([
            .object([
                "id": .string("workspace-mosaic"),
                "title": .string("mosaic"),
                "selected": .bool(true),
                "pinned": .bool(true),
                "index": .int(0),
                "directory": .string("/Users/me/src/mosaic"),
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/emergent-inc/mosaic/pull/5812"),
                    "status": .string("open"),
                    "stale": .bool(false),
                    "branch": .string("fix-crash-on-launch"),
                ]),
                ...
                "tabs": .array([
                    ...
                    .object([
                        ...
                        "focused": .bool(false),
                        "pinned": .bool(true),
                        "directory": .string("/Users/me/src/mosaic/web"),
                        "branch": .string("fix-crash-on-launch"),
                        "dirty": .bool(false),
            ...
            .object([
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/emergent-inc/mosaic/pull/5801"),
