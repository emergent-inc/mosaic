...
/// A strongly-typed handle to a setting persisted in the mosaic JSON config file.
///
/// `JSONKey` is one of two key flavors in ``MosaicSettings``; the other is
...
public struct JSONKey<Value: SettingCodable>: Sendable, Equatable {
    /// The dotted identifier (also the JSON path inside the mosaic config file).
