...
public struct SidebarCatalogSection: SettingCatalogSection {
    ...
    /// shipped mosaic build; using an enum here would silently revert
    ...
    public let openPullRequestLinksInMosaicBrowser = DefaultsKey<Bool>(
        id: "sidebar.openPullRequestLinksInMosaicBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenSidebarPullRequestLinksInMosaicBrowser"
    )

    public let openPortLinksInMosaicBrowser = DefaultsKey<Bool>(
        id: "sidebar.openPortLinksInMosaicBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenSidebarPortLinksInMosaicBrowser"
    )
