...
public struct BrowserCatalogSection: SettingCatalogSection {
    ...
    public let openTerminalLinksInMosaicBrowser = DefaultsKey<Bool>(
        id: "browser.openTerminalLinksInMosaicBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenTerminalLinksInMosaicBrowser"
    )

    public let interceptTerminalOpenCommandInMosaicBrowser = DefaultsKey<Bool>(
        id: "browser.interceptTerminalOpenCommandInMosaicBrowser",
        defaultValue: true,
        userDefaultsKey: "browserInterceptTerminalOpenCommandInMosaicBrowser"
    )
    ...
    /// "Enable mosaic Browser" toggle was a no-op until this was aligned.)
