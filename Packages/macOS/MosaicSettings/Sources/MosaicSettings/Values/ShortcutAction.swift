...
/// The stable, user-customisable shortcut actions mosaic exposes.
///
...
/// identifier persisted in mosaic.json.
...
extension ShortcutAction {
    ...
    ///
    /// Most mosaic-owned shortcuts require a modifier on the first stroke to avoid
