...
struct BrowserSearchSettingsStoreTests {
    ...
    @Test func validatesAndRendersSearchURLTemplates() throws {
        ...
        #expect(placeholderURL.absoluteString.contains("src=mosaic"))
        #expect(appendedURL.absoluteString.contains("source=mosaic"))
    ...
    private func makeDefaults() throws -> (UserDefaults, String) {
        let suiteName = "mosaic.browserSearchSettingsStoreTests.\(UUID().uuidString)"
