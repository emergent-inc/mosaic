...
///
/// DEBUG-only test scaffolding. The feed contents are driven by `MOSAIC_UI_TEST_*` environment
/// variables.
final class UpdateTestURLProtocol: URLProtocol {
    static let host = "mosaic.test"
    static let appcastPath = "/appcast.xml"
    static let updatePath = "/mosaic-test.zip"
    ...
    private static func appcastData() -> Data {
        ...
        let mode = env["MOSAIC_UI_TEST_FEED_MODE"] ?? "available"
        ...
        <rss version="2.0"
          ...
          <channel>
            <title>mosaic Test Updates</title>
