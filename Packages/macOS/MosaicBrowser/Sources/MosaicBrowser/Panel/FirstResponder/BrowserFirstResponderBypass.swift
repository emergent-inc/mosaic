...
///
/// Faithfully lifted from the app target's `mosaicWindowFirstResponderBypassDepth`
/// global plus the `mosaicWithWindowFirstResponderBypass` /
/// `mosaicIsWindowFirstResponderBypassActive` free functions. The depth counter
