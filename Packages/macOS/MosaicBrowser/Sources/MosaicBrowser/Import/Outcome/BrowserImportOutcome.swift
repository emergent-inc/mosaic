...
/// scope and domain filters, any mosaic profiles created, and the per-mapping
/// outcome entries.
public struct BrowserImportOutcome: Sendable {
    ...
    /// Display names of mosaic profiles created during this import.
    ...
    ///   - createdDestinationProfileNames: Names of mosaic profiles created.
    ...
    /// JSON-serializable representation sent over the mosaic automation socket.
