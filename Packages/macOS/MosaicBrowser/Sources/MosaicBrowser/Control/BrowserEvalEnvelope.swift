...
///
/// The default values are the exact strings the mosaic v2 browser RPC wire format
...
public struct BrowserEvalEnvelope: Sendable, Equatable {
    ...
    /// - Parameters:
    ///   - typeKey: JSON key for the discriminator. Defaults to the wire value `"__mosaic_t"`.
    ///   - valueKey: JSON key for the payload. Defaults to the wire value `"__mosaic_v"`.
    ...
    public init(
        typeKey: String = "__mosaic_t",
        valueKey: String = "__mosaic_v",
