...
public struct MosaicSidebarProviderWorkspace: Identifiable, Codable, Equatable, Sendable {
    /// Workspace id.
    public var id: UUID
    /// Display title.
    ...
    public var gitBranches: [MosaicSidebarProviderGitBranch]
    ...
    public init(
        ...
        gitBranches: [MosaicSidebarProviderGitBranch] = []
    ) {
        self.id = id
        self.title = title
