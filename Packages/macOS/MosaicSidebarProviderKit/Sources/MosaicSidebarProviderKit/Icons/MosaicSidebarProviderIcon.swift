...
public struct MosaicSidebarProviderIcon: Codable, Equatable, Sendable {
    ...
    /// Background shape.
    public var shape: MosaicSidebarProviderIconShape
    ...
    public init(
        ...
        shape: MosaicSidebarProviderIconShape = .circle
    ) {
