...
public enum ControlPaneCreateResolution: Sendable, Equatable {
    ...
    /// A browser split was requested while the mosaic browser is disabled and an
    ...
    /// A browser split was requested while the mosaic browser is disabled and no
    /// URL was supplied (legacy `browser_disabled` / "mosaic browser is
    /// disabled", `data: nil`).
    case browserDisabledNoURL
    /// A browser split was requested while the mosaic browser is disabled and the
