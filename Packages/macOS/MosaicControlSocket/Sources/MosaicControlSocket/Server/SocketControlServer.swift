public import MosaicSettings
internal import Dispatch
internal import Foundation
internal import os

/// The mosaic control-socket listener: path reservation, bind/listen lifecycle,
...
public final class SocketControlServer {
    ...
    struct ListenerState {
        ...
        var accessMode: SocketControlMode = .mosaicOnly
    }
    ...
    nonisolated let socketListenerQueue = DispatchQueue(label: "com.mosaic.socket.listener")
