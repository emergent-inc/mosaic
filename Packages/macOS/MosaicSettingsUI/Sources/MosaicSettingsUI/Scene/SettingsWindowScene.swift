...
/// section's anchor on click. This mirrors what mosaic's settings
...
public struct SettingsWindowScene: Scene {
    ...
    public var body: some Scene {
        WindowGroup(String(localized: "settings.title", defaultValue: "Settings"), id: "mosaic.settings") {
...
public struct SettingsWindowRoot: View {
    ...
    // sidebar selection changes plus an external app.mosaic.settings
    ...
    public var body: some View {
        ...
        // its declared mosaic.json paths to scroll/highlight anchor ids,
    ...
    /// Posts a `mosaic.settings.navigate` notification with the same
    ...
    /// Navigates from outside (e.g., a `mosaic.settings.navigate`
