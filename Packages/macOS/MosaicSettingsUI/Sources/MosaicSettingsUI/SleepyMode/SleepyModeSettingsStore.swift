...
///
/// This (and `SleepyModeConfig` / the theme enums) lives in MosaicSettingsUI by
/// design: Sleepy Mode appearance is user *settings*, and MosaicSettingsUI is
/// mosaic's settings-model module — it already houses the other persisted settings
