    ...
    private var customSidebarsRow: some View {
        SettingsCardRow(
            ...
            subtitle: customSidebars.current
                ? String(localized: "settings.betaFeatures.customSidebars.subtitleOn", defaultValue: "Lists your sidebars from ~/.config/mosaic/sidebars in the sidebar picker, rendered in an isolated helper process.")
