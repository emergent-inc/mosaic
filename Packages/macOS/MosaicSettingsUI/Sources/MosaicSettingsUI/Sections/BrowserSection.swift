...
public struct BrowserSection: View {
    ...
    public init(
        ...
        _openTermLinks = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.browser.openTerminalLinksInMosaicBrowser))
        _interceptOpen = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.browser.interceptTerminalOpenCommandInMosaicBrowser))
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            // Open Terminal Links
            SettingsCardRow(
                configurationReview: .json("browser.openTerminalLinksInMosaicBrowser"),
            ...
            // Intercept open
            SettingsCardRow(
                configurationReview: .json("browser.interceptTerminalOpenCommandInMosaicBrowser"),
