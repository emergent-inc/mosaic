...
/// **mosaic.json** section — mirrors the legacy in-app section: a card
...
public struct SettingsJSONSection: View {
    ...
    public var body: some View {
        Group {
            SettingsSectionHeader(String(localized: "settings.section.settingsJSON", defaultValue: "mosaic.json"), section: .settingsJSON)
    ...
    private var documentationRow: some View {
        SettingsCardRow(
            ...
            Link(
                ...
                destination: URL(string: "https://mosaic.inc/docs/configuration#mosaic-json")!
            )
            .mosaicFont(.caption)
