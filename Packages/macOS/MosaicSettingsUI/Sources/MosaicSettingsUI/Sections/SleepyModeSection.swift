            ...
            SettingsCard {
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.theme) {
                        Text(String(localized: "sleepyMode.theme.mosaic", defaultValue: "mosaic")).tag(SleepyTheme.mosaic)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.mascot) {
                        Text(String(localized: "sleepyMode.mascot.mosaic", defaultValue: "mosaic mascot")).tag(SleepyMascot.mosaic)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.glow) {
                        ...
                        Text(String(localized: "sleepyMode.glow.mosaic", defaultValue: "mosaic")).tag(SleepyGlow.mosaic)
