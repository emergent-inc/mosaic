...
extension Array where Element == CuratedSettingEntry {
    /// The mosaic-shipped curated search entries.
    ///
    ...
    public static var mosaicDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "supported-file-previews", title: "Open Supported Files in mosaic", synonyms: "app.openSupportedFilesInMosaic cmd click file preview pdf image video audio quicklook quick look editor external"),
            .init(section: .app, id: "markdown-viewer", title: "Open Markdown in mosaic Viewer", synonyms: "app.openMarkdownInMosaicViewer md markdown mdx viewer preview readme"),
            ...
            .init(section: .sidebarAppearance, id: "open-pr-links", title: "Open Sidebar PR Links in mosaic Browser", synonyms: "sidebar.openPullRequestLinksInMosaicBrowser pr links github browser default external embedded"),
            .init(section: .sidebarAppearance, id: "open-port-links", title: "Open Sidebar Port Links in mosaic Browser", synonyms: "sidebar.openPortLinksInMosaicBrowser ports localhost links browser default external embedded"),
            ...
            .init(section: .automation, id: "port-base", title: "Port Base", synonyms: "automation.portBase mosaic_port start first base env environment variable"),
            .init(section: .automation, id: "port-range", title: "Port Range Size", synonyms: "automation.portRange mosaic_port_end range size count env ports"),
            ...
            .init(section: .browser, id: "terminal-links", title: "Open Terminal Links in mosaic Browser", synonyms: "browser.openTerminalLinksInMosaicBrowser click url terminal links open in browser href"),
            .init(section: .browser, id: "intercept-open", title: "Intercept open http(s) in Terminal", synonyms: "browser.interceptTerminalOpenCommandInMosaicBrowser open command http https url terminal intercept"),
            ...
            .init(
                ...
                synonyms: [
                    "shortcuts.bindings hotkeys keybindings key bindings commands keyboard accelerators chords mosaic json open diff viewer changes review git unstaged split left split right split up split down new pane new split move surface move tab focus pane resize pane close tab close workspace next previous select workspace",
            ...
            .init(section: .keyboardShortcuts, id: "shortcut-chords", title: "Shortcut Chords", synonyms: "tmux prefix ctrl-b control-b multi key sequence chord mosaic json"),
            ...
            // mosaic.json
            .init(section: .settingsJSON, id: "open-file", title: "User config file", synonyms: "open config file json jsonc config editor ~/.config mosaic preferences"),
            .init(section: .settingsJSON, id: "documentation", title: "Documentation", synonyms: "docs documentation schema reference mosaic json keys configuration"),
