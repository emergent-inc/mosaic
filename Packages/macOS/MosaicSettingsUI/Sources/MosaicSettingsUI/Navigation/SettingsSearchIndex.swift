...
public struct SettingsSearchIndex: Sendable {
    ...
    /// Maps a dotted mosaic.json path (e.g. `sidebar.showBranchDirectory`)
    ...
    ///     ``Swift/Array/mosaicDefault`` — the table the mosaic app ships
    ...
    /// Resolves a dotted mosaic.json path to the curated entry id the
    ...
    ///
    /// - Parameter path: A dotted mosaic.json path, e.g. `terminal.copyOnSelect`.
