...
[Tải cmux NIGHTLY](https://github.com/emergent-inc/cmux/releases/download/nightly/cmux-nightly-macos.dmg)
...
Báo lỗi nightly trên [GitHub Issues](https://github.com/emergent-inc/cmux/issues) hoặc trong [#nightly-bugs trên Discord](https://discord.gg/xsgFEVrWCZ).
...
Có. Skill là các workflow tái sử dụng mà bạn có thể trao cho bất kỳ agent nào chạy trong cmux, cho những việc như điều khiển CLI, tự động hóa workspace, cài đặt, và surface trình duyệt. Duyệt bộ sưu tập mở tại [cmux-skills](https://github.com/emergent-inc/cmux-skills), hoặc đọc [tài liệu skill](https://cmux.com/docs/skills).
...
Có, cmux miễn phí để dùng. Mã nguồn có sẵn trên [GitHub](https://github.com/emergent-inc/cmux).

### Tôi có thể hỗ trợ cmux như thế nào?

cmux miễn phí và mã nguồn mở, và sẽ luôn như vậy. Nếu bạn muốn ủng hộ việc phát triển và có quyền truy cập sớm vào những thứ sắp tới, gồm cmux AI, app iOS, và Cloud VMs, hãy xem [cmux Founders Edition](https://github.com/emergent-inc/cmux#founders-edition).

### Tôi có yêu cầu tính năng hoặc tìm thấy lỗi?

Chúng tôi rất muốn nghe. Mở một [issue](https://github.com/emergent-inc/cmux/issues) hoặc [pull request](https://github.com/emergent-inc/cmux/pulls) trên GitHub, hoặc [gửi email cho chúng tôi](mailto:contact@emergent.inc?subject=cmux%20feature%20request).
...
<a href="https://star-history.com/#emergent-inc/cmux&Date">
 <picture>
   ...
   <img alt="Biểu đồ lịch sử sao" src="https://api.star-history.com/svg?repos=emergent-inc/cmux&type=Date" width="600" />
 </picture>
</a>
...
- Theo dõi chúng tôi trên X để cập nhật [@emergentinc](https://x.com/emergentinc), [@lawrencecchen](https://x.com/lawrencecchen), và [@austinywang](https://x.com/austinywang)
- Tham gia trò chuyện trên [Discord](https://discord.gg/xsgFEVrWCZ)
- Tạo và tham gia [GitHub issues](https://github.com/emergent-inc/cmux/issues) và [discussions](https://github.com/emergent-inc/cmux/discussions)
...
Nếu tổ chức của bạn không thể tuân thủ GPL, giấy phép thương mại có sẵn. Liên hệ [contact@emergent.inc](mailto:contact@emergent.inc) để biết chi tiết.
